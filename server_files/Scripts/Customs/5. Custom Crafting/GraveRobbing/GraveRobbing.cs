...
namespace Server.Engines.Harvest
{
	public class GraveRobbing : HarvestSystem
	{
		...
		private GraveRobbing()
		{
			...
			{
				new HarvestResource( 020.0, 010.0, 150.0, "You put some Bones in your backpack",		typeof( Bones2 ),	typeof( VengefulSpirit ) ),
				...
				new HarvestResource( 065.0, 040.0, 150.0, "You put some Treasure in your backpack",	typeof( RandomSkillJewelryX ) )
			};
			...
			veins = new HarvestVein[]
			{
				...
				new HarvestVein( 10.0, 0.5, res[5], res[0] )	// RandomSkillJewelryX
			};
