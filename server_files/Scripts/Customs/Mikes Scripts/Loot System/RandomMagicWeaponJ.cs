...
public class RandomMagicWeaponJ : BaseWeapon
{
    ...
    [Constructable]
    public RandomMagicWeaponJ() : base(GetRandomItemID())
    {
	...
	private void InitializeWeaponAttributes(BaseWeapon tempWeapon)
	{
		...
		if (tierChance < 0.05) // Very rare
		{
            ...
            this.WeaponAttributes.HitLeechHits = rand.Next(20, 41); // Chance to leech hits
            this.WeaponAttributes.HitLeechMana = rand.Next(20, 41); // Chance to leech mana
            this.WeaponAttributes.HitLeechStam = rand.Next(20, 41); // Chance to leech stamina
		}
		...
		else if (tierChance < 0.5) // Uncommon
		{
			...
			this.WeaponAttributes.HitLeechHits = rand.Next(5, 16);
    ...
    public RandomMagicWeaponJ(Serial serial) : base(serial) { }
