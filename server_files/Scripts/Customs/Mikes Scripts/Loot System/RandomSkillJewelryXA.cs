...
public class RandomSkillJewelryXA : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryXA() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void SetRandomSkills(int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 10); // Or another range depending on balance
    ...
    public RandomSkillJewelryXA(Serial serial) : base(serial) { }
