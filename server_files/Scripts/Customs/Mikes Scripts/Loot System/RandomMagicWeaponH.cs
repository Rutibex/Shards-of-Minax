...
public class RandomMagicWeaponH : BaseWeapon
{
    ...
    [Constructable]
    public RandomMagicWeaponH() : base(GetRandomItemID())
    {
    ...
    private void InitializeWeaponAttributes(BaseWeapon tempWeapon)
    {
        ...
        // Tiered system for weapon bonuses
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            // Add additional very rare bonuses here
            this.WeaponAttributes.HitLeechHits = rand.Next(10, 21);
            this.WeaponAttributes.HitLeechMana = rand.Next(10, 21);
        }
        else if (tierChance < 0.2) // Rare
        {
            this.MinDamage = rand.Next(1, 70);
            this.MaxDamage = rand.Next(70, 200);
            // Add additional rare bonuses here
            this.WeaponAttributes.HitFireball = rand.Next(20, 41);
            this.WeaponAttributes.HitLeechStam = rand.Next(10, 21);
        }
        else if (tierChance < 0.5) // Uncommon
        {
            this.MinDamage = rand.Next(1, 50);
            this.MaxDamage = rand.Next(50, 150);
            // Add additional uncommon bonuses here
            this.WeaponAttributes.HitDispel = rand.Next(10, 26);
            this.WeaponAttributes.HitManaDrain = rand.Next(10, 26);
        }
        else // Common
        {
            this.MinDamage = rand.Next(1, 30);
            this.MaxDamage = rand.Next(30, 100);
            // Add additional common bonuses here
            this.WeaponAttributes.HitHarm = rand.Next(10, 26);
            this.WeaponAttributes.HitFatigue = rand.Next(10, 26);
        }
    }
    ...
    public RandomMagicWeaponH(Serial serial) : base(serial) { }
