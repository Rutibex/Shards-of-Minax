...
public class RandomMagicWeaponC : BaseWeapon
{
    ...
    [Constructable]
    public RandomMagicWeaponC() : base(GetRandomItemID())
    {
    ...
    private void InitializeWeaponAttributes(BaseWeapon tempWeapon)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            this.WeaponAttributes.HitPoisonArea = rand.Next(20, 31); // Example: Chance of Poison
            this.WeaponAttributes.HitLeechHits = rand.Next(20, 31); // Example: Chance of Leech Hits
        }
        else if (tierChance < 0.2) // Rare
        {
            this.MinDamage = rand.Next(1, 70);
            this.MaxDamage = rand.Next(70, 200);
            this.WeaponAttributes.HitLeechHits = rand.Next(10, 21); // Example: Chance of Leech Hits
            this.WeaponAttributes.HitFireball = rand.Next(20, 41); // Example: Chance of Fireball
        }
        else if (tierChance < 0.5) // Uncommon
        {
            this.MinDamage = rand.Next(1, 50);
            this.MaxDamage = rand.Next(50, 150);
            this.WeaponAttributes.HitHarm = rand.Next(10, 26); // Example: Chance of Harm
        }
        else // Common
        {
    ...
    public RandomMagicWeaponC(Serial serial) : base(serial) { }
