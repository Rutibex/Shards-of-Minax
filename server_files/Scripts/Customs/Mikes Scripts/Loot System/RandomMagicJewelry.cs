...
public class RandomMagicJewelry : BaseJewel
{
    ...
    [Constructable]
    public RandomMagicJewelry() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
			...
			this.Attributes.CastRecovery = Utility.RandomMinMax(3, 5);
			this.Attributes.CastSpeed = Utility.RandomMinMax(3, 5);
			this.Attributes.LowerManaCost = Utility.RandomMinMax(0, 55);
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            this.Attributes.RegenHits = rand.Next(1, 2);
            // Add more rare attributes
			this.Attributes.SpellDamage = Utility.RandomMinMax(0, 99);
			this.Attributes.CastRecovery = Utility.RandomMinMax(2, 3);
			this.Attributes.CastSpeed = Utility.RandomMinMax(2, 3);
			this.Attributes.LowerManaCost = Utility.RandomMinMax(0, 29);
			this.Attributes.LowerRegCost = Utility.RandomMinMax(0, 29);
        ...
        else if (tierChance < 0.5) // Uncommon
        {
			...
			// Medium bonuses
			this.Attributes.SpellDamage = Utility.RandomMinMax(0, 49);
			this.Attributes.CastRecovery = Utility.RandomMinMax(1, 2);
			this.Attributes.CastSpeed = Utility.RandomMinMax(1, 2);
			this.Attributes.LowerManaCost = Utility.RandomMinMax(0, 19);
			this.Attributes.LowerRegCost = Utility.RandomMinMax(0, 19);
        ...
        else // Common
        {
			...
			// Lowest bonuses
			this.Attributes.SpellDamage = Utility.RandomMinMax(0, 24);
			this.Attributes.CastRecovery = 1;
			this.Attributes.CastSpeed = 1;
			this.Attributes.LowerManaCost = Utility.RandomMinMax(0, 9);
			this.Attributes.LowerRegCost = Utility.RandomMinMax(0, 9);
