...
public class RandomMagicClothingXC : BaseClothing
{
    ...
    [Constructable]
    public RandomMagicClothingXC() : base(GetRandomItemID(), Layer.OuterTorso)
    {
    ...
    private void InitializeClothingAttributes(BaseClothing tempClothing)
    {
        ...
        {
            SetRandomSkills(this, 3); // Assign 3 random skills
        ...
        {
            SetRandomSkills(this, 2); // Assign 2 random skills
            // Set other attributes as before
        ...
        {
            SetRandomSkills(this, 1); // Assign 1 random skill
            // Set other attributes as before
    ...
    private void SetRandomSkills(BaseClothing clothing, int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            SkillName randomSkill = allSkills[rand.Next(allSkills.Length)];
            int randomValue = Utility.RandomMinMax(0, 40); // Adjust range based on balance needs
    ...
    public RandomMagicClothingXC(Serial serial) : base(serial) { }
