...
public class RandomMagicWeaponF : BaseWeapon
{
    ...
    [Constructable]
    public RandomMagicWeaponF() : base(GetRandomItemID())
    {
    ...
    private void InitializeWeaponAttributes(BaseWeapon tempWeapon)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            this.WeaponAttributes.HitLeechHits = rand.Next(20, 31); // Chance to leech hits
            this.WeaponAttributes.HitLeechMana = rand.Next(10, 21); // Chance to leech mana
        }
        else if (tierChance < 0.2) // Rare
        {
            ...
            this.WeaponAttributes.HitLeechHits = rand.Next(10, 21); // Chance to leech hits
        }
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            this.WeaponAttributes.HitHarm = rand.Next(10, 21); // Chance to harm
        }
        else // Common
        {
            this.MinDamage = rand.Next(1, 30);
            this.MaxDamage = rand.Next(30, 100);
            this.WeaponAttributes.HitPoisonArea = rand.Next(10, 21); // Chance to poison
        }
    ...
    public RandomMagicWeaponF(Serial serial) : base(serial) { }
