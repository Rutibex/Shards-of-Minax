...
public class RandomMagicClothingXD : BaseClothing
{
    ...
    [Constructable]
    public RandomMagicClothingXD() : base(GetRandomItemID(), Layer.OuterTorso)
    {
    ...
    private void SetRandomSkills(BaseClothing clothing, int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 50); // Adjust range based on balance needs
    ...
    public RandomMagicClothingXD(Serial serial) : base(serial) { }
