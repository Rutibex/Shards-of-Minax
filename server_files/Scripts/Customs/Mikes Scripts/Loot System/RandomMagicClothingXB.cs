...
public class RandomMagicClothingXB : BaseClothing
{
    ...
    [Constructable]
    public RandomMagicClothingXB() : base(GetRandomItemID(), Layer.OuterTorso)
    {
    ...
    private void SetRandomSkills(BaseClothing clothing, int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 30); // Adjust range based on balance needs
    ...
    public RandomMagicClothingXB(Serial serial) : base(serial) { }
