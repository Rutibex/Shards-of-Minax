...
public class RandomSkillJewelryXD : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryXD() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void SetRandomSkills(int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 40); // Or another range depending on balance
    ...
    public RandomSkillJewelryXD(Serial serial) : base(serial) { }
