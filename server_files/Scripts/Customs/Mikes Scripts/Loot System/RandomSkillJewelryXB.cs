...
public class RandomSkillJewelryXB : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryXB() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void SetRandomSkills(int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 20); // Or another range depending on balance
    ...
    public RandomSkillJewelryXB(Serial serial) : base(serial) { }
