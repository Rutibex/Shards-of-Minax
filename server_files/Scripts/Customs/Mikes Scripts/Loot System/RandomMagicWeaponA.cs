...
public class RandomMagicWeaponA : BaseWeapon
{
    ...
    [Constructable]
    public RandomMagicWeaponA() : base(GetRandomItemID())
    {
    ...
    private void InitializeWeaponAttributes(BaseWeapon tempWeapon)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            this.WeaponAttributes.HitLeechMana = rand.Next(40, 51); // Example: High chance of Mana Leech
            this.WeaponAttributes.HitLeechStam = rand.Next(20, 31); // Example: Chance to leech Stamina
        }
        else if (tierChance < 0.2) // Rare
        {
            this.MinDamage = rand.Next(1, 70);
            this.MaxDamage = rand.Next(70, 200);
            this.WeaponAttributes.HitLeechHits = rand.Next(20, 41); // Example: Chance of Hit Point Leech
            this.WeaponAttributes.HitLowerAttack = rand.Next(10, 21); // Example: Chance to lower opponent's attack
        }
        else if (tierChance < 0.5) // Uncommon
        {
            this.MinDamage = rand.Next(1, 50);
            this.MaxDamage = rand.Next(50, 150);
            this.WeaponAttributes.HitFireball = rand.Next(10, 26); // Example: Chance to cast Fireball
        }
        else // Common
        {
    ...
    public RandomMagicWeaponA(Serial serial) : base(serial) { }
