...
public class RandomMagicWeaponM : BaseWeapon
{
    ...
    [Constructable]
    public RandomMagicWeaponM() : base(GetRandomItemID())
    {
    ...
    private void InitializeWeaponAttributes(BaseWeapon tempWeapon)
    {
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            this.WeaponAttributes.HitLeechMana = rand.Next(5, 16); // Chance to leech mana
        }
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            this.WeaponAttributes.HitLeechStam = rand.Next(8, 18); // Chance to leech stamina
        }
        else // Common
        {
    ...
    public RandomMagicWeaponM(Serial serial) : base(serial) { }
