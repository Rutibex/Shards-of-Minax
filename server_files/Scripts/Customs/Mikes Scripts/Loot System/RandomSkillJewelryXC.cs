...
public class RandomSkillJewelryXC : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryXC() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void SetRandomSkills(int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 30); // Or another range depending on balance
    ...
    public RandomSkillJewelryXC(Serial serial) : base(serial) { }
