...
public class RandomMagicWeaponD : BaseWeapon
{
    ...
    [Constructable]
    public RandomMagicWeaponD() : base(GetRandomItemID())
    {
    ...
    private void InitializeWeaponAttributes(BaseWeapon tempWeapon)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            this.WeaponAttributes.HitLeechHits = rand.Next(40, 51); // Example: Chance to leech hits
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            this.WeaponAttributes.HitLeechMana = rand.Next(20, 41); // Example: Chance to leech mana
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            this.WeaponAttributes.HitHarm = rand.Next(10, 26); // Example: Chance to cast Harm
    ...
    public RandomMagicWeaponD(Serial serial) : base(serial) { }
