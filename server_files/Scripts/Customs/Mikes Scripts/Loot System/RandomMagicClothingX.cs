...
public class RandomMagicClothingX : BaseClothing
{
    ...
    [Constructable]
    public RandomMagicClothingX() : base(GetRandomItemID(), Layer.OuterTorso)
    {
    ...
    private void SetRandomSkills(BaseClothing clothing, int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 100); // Adjust range based on balance needs
    ...
    public RandomMagicClothingX(Serial serial) : base(serial) { }
