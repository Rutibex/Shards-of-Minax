...
public class RandomMagicClothingXA : BaseClothing
{
    ...
    [Constructable]
    public RandomMagicClothingXA() : base(GetRandomItemID(), Layer.OuterTorso)
    {
    ...
    private void SetRandomSkills(BaseClothing clothing, int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 20); // Adjust range based on balance needs
    ...
    public RandomMagicClothingXA(Serial serial) : base(serial) { }
