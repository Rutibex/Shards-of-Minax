...
public class RandomSkillJewelryXE : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryXE() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void SetRandomSkills(int numberOfSkills)
    {
        for (int i = 0; i < numberOfSkills; i++)
        {
            ...
            int randomValue = Utility.RandomMinMax(0, 50); // Or another range depending on balance
    ...
    public RandomSkillJewelryXE(Serial serial) : base(serial) { }
