...
namespace Server.Mobiles
{
    ...
    public class RandomKnightLord : BaseCreature
    {
        ...
        [Constructable]
        public RandomKnightLord() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomKnightLord(Serial serial) : base(serial)
        {
        }
