...
namespace Server.Mobiles
{
    ...
    public class RandomSlime : BaseCreature
    {
        ...
        [Constructable]
        public RandomSlime() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomSlime(Serial serial) : base(serial)
        {
        }
