...
namespace Server.Mobiles
{
    ...
    public class RandomElemental : BaseCreature
    {
        ...
        [Constructable]
        public RandomElemental() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomElemental(Serial serial) : base(serial)
        {
        }
