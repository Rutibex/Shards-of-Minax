...
namespace Server.Mobiles
{
    ...
    public class RandomRodent : BaseCreature
    {
        ...
        [Constructable]
        public RandomRodent() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomRodent(Serial serial) : base(serial)
        {
        }
