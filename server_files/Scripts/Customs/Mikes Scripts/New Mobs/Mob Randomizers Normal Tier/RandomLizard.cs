...
namespace Server.Mobiles
{
    ...
    public class RandomLizard : BaseCreature
    {
        ...
        [Constructable]
        public RandomLizard() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomLizard(Serial serial) : base(serial)
        {
        }
