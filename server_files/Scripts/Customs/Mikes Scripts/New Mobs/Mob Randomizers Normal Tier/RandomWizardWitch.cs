...
namespace Server.Mobiles
{
    ...
    public class RandomWizardWitch : BaseCreature
    {
        ...
        [Constructable]
        public RandomWizardWitch() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomWizardWitch(Serial serial) : base(serial)
        {
        }
