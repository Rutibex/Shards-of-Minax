...
namespace Server.Mobiles
{
    ...
    public class RandomRobot : BaseCreature
    {
        ...
        [Constructable]
        public RandomRobot() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomRobot(Serial serial) : base(serial)
        {
        }
