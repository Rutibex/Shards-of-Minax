...
namespace Server.Mobiles
{
    ...
    public class RandomAngel : BaseCreature
    {
        ...
        [Constructable]
        public RandomAngel() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomAngel(Serial serial) : base(serial)
        {
        }
