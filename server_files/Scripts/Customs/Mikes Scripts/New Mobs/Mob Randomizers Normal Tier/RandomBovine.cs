...
namespace Server.Mobiles
{
    ...
    public class RandomBovine : BaseCreature
    {
        ...
        [Constructable]
        public RandomBovine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomBovine(Serial serial) : base(serial)
        {
        }
