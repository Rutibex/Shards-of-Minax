...
namespace Server.Mobiles
{
    ...
    public class RandomAnimatedPlant : BaseCreature
    {
        ...
        [Constructable]
        public RandomAnimatedPlant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomAnimatedPlant(Serial serial) : base(serial)
        {
        }
