...
namespace Server.Mobiles
{
    ...
    public class RandomMinotaur : BaseCreature
    {
        ...
        [Constructable]
        public RandomMinotaur() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomMinotaur(Serial serial) : base(serial)
        {
        }
