...
namespace Server.Mobiles
{
    ...
    public class RandomCanine : BaseCreature
    {
        ...
        [Constructable]
        public RandomCanine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomCanine(Serial serial) : base(serial)
        {
        }
