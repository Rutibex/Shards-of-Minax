...
namespace Server.Mobiles
{
    ...
    public class RandomMonster : BaseCreature
    {
        ...
        [Constructable]
        public RandomMonster() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomMonster(Serial serial) : base(serial)
        {
        }
