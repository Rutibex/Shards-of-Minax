...
namespace Server.Mobiles
{
    ...
    public class RandomRidable : BaseMount
    {
        ...
        [Constructable]
        public RandomRidable() : base("a unique mount", Utility.RandomList(ridableBodies), Utility.RandomList(ridableBodies), AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
