...
namespace Server.Mobiles
{
    ...
    public class RandomDragon : BaseCreature
    {
        ...
        [Constructable]
        public RandomDragon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomDragon(Serial serial) : base(serial)
        {
        }
