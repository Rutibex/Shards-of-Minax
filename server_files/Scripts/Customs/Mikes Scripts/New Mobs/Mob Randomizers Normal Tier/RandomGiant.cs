...
namespace Server.Mobiles
{
    ...
    public class RandomGiant : BaseCreature
    {
        ...
        [Constructable]
        public RandomGiant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomGiant(Serial serial) : base(serial)
        {
        }
