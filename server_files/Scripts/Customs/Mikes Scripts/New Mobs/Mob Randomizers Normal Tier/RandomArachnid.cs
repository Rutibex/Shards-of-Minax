...
namespace Server.Mobiles
{
    ...
    public class RandomArachnid : BaseCreature
    {
        ...
        [Constructable]
        public RandomArachnid() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomArachnid(Serial serial) : base(serial)
        {
        }
