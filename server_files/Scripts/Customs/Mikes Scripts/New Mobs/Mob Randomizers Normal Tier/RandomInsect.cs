...
namespace Server.Mobiles
{
    ...
    public class RandomInsect : BaseCreature
    {
        ...
        [Constructable]
        public RandomInsect() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomInsect(Serial serial) : base(serial)
        {
        }
