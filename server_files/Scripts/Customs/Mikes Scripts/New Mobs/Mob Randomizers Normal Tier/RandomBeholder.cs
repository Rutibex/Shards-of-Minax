...
namespace Server.Mobiles
{
    ...
    public class RandomBeholder : BaseCreature
    {
        ...
        [Constructable]
        public RandomBeholder() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomBeholder(Serial serial) : base(serial)
        {
        }
