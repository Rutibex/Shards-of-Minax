...
namespace Server.Mobiles
{
    ...
    public class RandomSnake : BaseCreature
    {
        ...
        [Constructable]
        public RandomSnake() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomSnake(Serial serial) : base(serial)
        {
        }
