...
namespace Server.Mobiles
{
    ...
    public class RandomGargoyle : BaseCreature
    {
        ...
        [Constructable]
        public RandomGargoyle() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomGargoyle(Serial serial) : base(serial)
        {
        }
