...
namespace Server.Mobiles
{
    ...
    public class RandomDemon : BaseCreature
    {
        ...
        [Constructable]
        public RandomDemon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomDemon(Serial serial) : base(serial)
        {
        }
