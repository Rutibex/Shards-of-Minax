...
namespace Server.Mobiles
{
    ...
    public class RandomUndead : BaseCreature
    {
        ...
        [Constructable]
        public RandomUndead() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public RandomUndead(Serial serial) : base(serial)
        {
        }
