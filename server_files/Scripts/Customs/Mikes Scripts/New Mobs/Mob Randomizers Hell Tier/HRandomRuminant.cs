...
namespace Server.Mobiles
{
    ...
    public class HRandomRuminant : BaseCreature
    {
        ...
        [Constructable]
        public HRandomRuminant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomRuminant(Serial serial) : base(serial)
        {
        }
