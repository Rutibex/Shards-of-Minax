...
namespace Server.Mobiles
{
    ...
    public class HRandomRodent : BaseCreature
    {
        ...
        [Constructable]
        public HRandomRodent() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomRodent(Serial serial) : base(serial)
        {
        }
