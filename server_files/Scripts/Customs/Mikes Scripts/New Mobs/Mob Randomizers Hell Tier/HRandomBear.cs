...
namespace Server.Mobiles
{
    ...
    public class HRandomBear : BaseCreature
    {
        ...
        [Constructable]
        public HRandomBear() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomBear(Serial serial) : base(serial)
        {
        }
