...
namespace Server.Mobiles
{
    ...
    public class HRandomBeholder : BaseCreature
    {
        ...
        [Constructable]
        public HRandomBeholder() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomBeholder(Serial serial) : base(serial)
        {
        }
