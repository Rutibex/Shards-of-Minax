...
namespace Server.Mobiles
{
    ...
    public class HRandomSnake : BaseCreature
    {
        ...
        [Constructable]
        public HRandomSnake() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomSnake(Serial serial) : base(serial)
        {
        }
