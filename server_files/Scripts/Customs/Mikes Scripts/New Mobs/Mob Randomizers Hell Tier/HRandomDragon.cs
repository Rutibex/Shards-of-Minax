...
namespace Server.Mobiles
{
    ...
    public class HRandomDragon : BaseCreature
    {
        ...
        [Constructable]
        public HRandomDragon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomDragon(Serial serial) : base(serial)
        {
        }
