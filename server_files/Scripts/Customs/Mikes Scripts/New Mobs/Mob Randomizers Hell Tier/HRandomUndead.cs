...
namespace Server.Mobiles
{
    ...
    public class HRandomUndead : BaseCreature
    {
        ...
        [Constructable]
        public HRandomUndead() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomUndead(Serial serial) : base(serial)
        {
        }
