...
namespace Server.Mobiles
{
    ...
    public class HRandomGiant : BaseCreature
    {
        ...
        [Constructable]
        public HRandomGiant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomGiant(Serial serial) : base(serial)
        {
        }
