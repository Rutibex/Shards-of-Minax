...
namespace Server.Mobiles
{
    ...
    public class HRandomSlime : BaseCreature
    {
        ...
        [Constructable]
        public HRandomSlime() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomSlime(Serial serial) : base(serial)
        {
        }
