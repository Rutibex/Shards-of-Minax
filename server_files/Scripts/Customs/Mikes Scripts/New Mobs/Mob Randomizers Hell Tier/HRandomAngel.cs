...
namespace Server.Mobiles
{
    ...
    public class HRandomAngel : BaseCreature
    {
        ...
        [Constructable]
        public HRandomAngel() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomAngel(Serial serial) : base(serial)
        {
        }
