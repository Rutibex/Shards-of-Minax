...
namespace Server.Mobiles
{
    ...
    public class HRandomArachnid : BaseCreature
    {
        ...
        [Constructable]
        public HRandomArachnid() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomArachnid(Serial serial) : base(serial)
        {
        }
