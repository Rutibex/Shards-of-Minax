...
namespace Server.Mobiles
{
    ...
    public class HRandomMinotaur : BaseCreature
    {
        ...
        [Constructable]
        public HRandomMinotaur() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomMinotaur(Serial serial) : base(serial)
        {
        }
