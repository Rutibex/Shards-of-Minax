...
namespace Server.Mobiles
{
    ...
    public class HRandomMonster : BaseCreature
    {
        ...
        [Constructable]
        public HRandomMonster() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomMonster(Serial serial) : base(serial)
        {
        }
