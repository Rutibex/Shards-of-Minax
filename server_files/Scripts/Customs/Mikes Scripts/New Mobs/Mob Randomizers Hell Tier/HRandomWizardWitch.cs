...
namespace Server.Mobiles
{
    ...
    public class HRandomWizardWitch : BaseCreature
    {
        ...
        [Constructable]
        public HRandomWizardWitch() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomWizardWitch(Serial serial) : base(serial)
        {
        }
