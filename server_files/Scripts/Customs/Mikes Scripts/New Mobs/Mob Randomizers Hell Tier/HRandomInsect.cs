...
namespace Server.Mobiles
{
    ...
    public class HRandomInsect : BaseCreature
    {
        ...
        [Constructable]
        public HRandomInsect() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomInsect(Serial serial) : base(serial)
        {
        }
