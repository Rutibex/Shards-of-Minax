...
namespace Server.Mobiles
{
    ...
    public class HRandomAnimatedPlant : BaseCreature
    {
        ...
        [Constructable]
        public HRandomAnimatedPlant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomAnimatedPlant(Serial serial) : base(serial)
        {
        }
