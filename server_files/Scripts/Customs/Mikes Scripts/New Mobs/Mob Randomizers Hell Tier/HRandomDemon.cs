...
namespace Server.Mobiles
{
    ...
    public class HRandomDemon : BaseCreature
    {
        ...
        [Constructable]
        public HRandomDemon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomDemon(Serial serial) : base(serial)
        {
        }
