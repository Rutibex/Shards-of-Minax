...
namespace Server.Mobiles
{
    ...
    public class HRandomElemental : BaseCreature
    {
        ...
        private const int NumberOfAbilitiesToAttach = 3;

        [Constructable]
        public HRandomElemental() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
		...
		private void PackPowerfulMagicWeapon()
		{
			...
			weapon.Hue = Utility.RandomMinMax(1501, 2000);
			PackItem(weapon);
		}
		...
		private void PackPowerfulMagicArmor()
		{
			...
			armor.Hue = Utility.RandomMinMax(1501, 2000);
			PackItem(armor);
		}
		...
		private void PackPowerfulMagicJewelry()
		{
			...
			jewel.Hue = Utility.RandomMinMax(1501, 2000);
			PackItem(jewel);
		}

        public HRandomElemental(Serial serial) : base(serial)
        {
        }
