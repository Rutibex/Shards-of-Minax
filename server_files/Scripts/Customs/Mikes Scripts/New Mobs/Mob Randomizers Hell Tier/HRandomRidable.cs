...
namespace Server.Mobiles
{
    ...
    public class HRandomRidable : BaseMount
    {
        ...
        [Constructable]
        public HRandomRidable() : base("a unique mount", Utility.RandomList(ridableBodies), Utility.RandomList(ridableBodies), AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomRidable(Serial serial) : base(serial)
        {
        }
