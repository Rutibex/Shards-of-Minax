...
namespace Server.Mobiles
{
    ...
    public class HRandomRobot : BaseCreature
    {
        ...
        [Constructable]
        public HRandomRobot() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomRobot(Serial serial) : base(serial)
        {
        }
