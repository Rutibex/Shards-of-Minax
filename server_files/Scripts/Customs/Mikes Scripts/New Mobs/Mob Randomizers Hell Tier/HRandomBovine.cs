...
namespace Server.Mobiles
{
    ...
    public class HRandomBovine : BaseCreature
    {
        ...
        [Constructable]
        public HRandomBovine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomBovine(Serial serial) : base(serial)
        {
        }
