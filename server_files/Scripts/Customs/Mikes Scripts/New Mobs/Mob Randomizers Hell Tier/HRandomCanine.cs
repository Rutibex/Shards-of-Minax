...
namespace Server.Mobiles
{
    ...
    public class HRandomCanine : BaseCreature
    {
        ...
        [Constructable]
        public HRandomCanine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomCanine(Serial serial) : base(serial)
        {
        }
