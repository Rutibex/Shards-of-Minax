...
namespace Server.Mobiles
{
    ...
    public class HRandomGargoyle : BaseCreature
    {
        ...
        [Constructable]
        public HRandomGargoyle() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomGargoyle(Serial serial) : base(serial)
        {
        }
