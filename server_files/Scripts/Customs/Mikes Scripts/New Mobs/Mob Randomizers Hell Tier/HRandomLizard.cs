...
namespace Server.Mobiles
{
    ...
    public class HRandomLizard : BaseCreature
    {
        ...
        [Constructable]
        public HRandomLizard() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public HRandomLizard(Serial serial) : base(serial)
        {
        }
