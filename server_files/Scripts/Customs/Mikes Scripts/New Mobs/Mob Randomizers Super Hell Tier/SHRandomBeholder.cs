...
namespace Server.Mobiles
{
    ...
    public class SHRandomBeholder : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomBeholder() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomBeholder(Serial serial) : base(serial)
        {
        }
