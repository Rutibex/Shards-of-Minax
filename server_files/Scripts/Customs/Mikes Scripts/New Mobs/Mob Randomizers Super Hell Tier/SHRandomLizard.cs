...
namespace Server.Mobiles
{
    ...
    public class SHRandomLizard : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomLizard() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomLizard(Serial serial) : base(serial)
        {
        }
