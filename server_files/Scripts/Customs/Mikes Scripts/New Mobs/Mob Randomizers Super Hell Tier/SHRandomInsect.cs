...
namespace Server.Mobiles
{
    ...
    public class SHRandomInsect : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomInsect() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomInsect(Serial serial) : base(serial)
        {
        }
