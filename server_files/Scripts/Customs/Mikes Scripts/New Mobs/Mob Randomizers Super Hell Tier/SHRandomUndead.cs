...
namespace Server.Mobiles
{
    ...
    public class SHRandomUndead : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomUndead() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomUndead(Serial serial) : base(serial)
        {
        }
