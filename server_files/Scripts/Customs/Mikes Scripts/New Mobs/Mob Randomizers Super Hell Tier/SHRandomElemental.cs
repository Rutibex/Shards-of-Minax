...
namespace Server.Mobiles
{
    ...
    public class SHRandomElemental : BaseCreature
    {
        ...
        private const int NumberOfAbilitiesToAttach = 4;

        [Constructable]
        public SHRandomElemental() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomElemental(Serial serial) : base(serial)
        {
        }
