...
namespace Server.Mobiles
{
    ...
    public class SHRandomSnake : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomSnake() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomSnake(Serial serial) : base(serial)
        {
        }
