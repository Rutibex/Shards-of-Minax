...
namespace Server.Mobiles
{
    ...
    public class SHRandomGargoyle : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomGargoyle() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomGargoyle(Serial serial) : base(serial)
        {
        }
