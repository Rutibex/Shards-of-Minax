...
namespace Server.Mobiles
{
    ...
    public class SHRandomMonster : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomMonster() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomMonster(Serial serial) : base(serial)
        {
        }
