...
namespace Server.Mobiles
{
    ...
    public class SHRandomCat : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomCat() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomCat(Serial serial) : base(serial)
        {
        }
