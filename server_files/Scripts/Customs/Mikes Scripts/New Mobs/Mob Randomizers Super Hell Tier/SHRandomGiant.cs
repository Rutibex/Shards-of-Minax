...
namespace Server.Mobiles
{
    ...
    public class SHRandomGiant : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomGiant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomGiant(Serial serial) : base(serial)
        {
        }
