...
namespace Server.Mobiles
{
    ...
    public class SHRandomRidable : BaseMount
    {
        ...
        [Constructable]
        public SHRandomRidable() : base("a unique mount", Utility.RandomList(ridableBodies), Utility.RandomList(ridableBodies), AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomRidable(Serial serial) : base(serial)
        {
        }
