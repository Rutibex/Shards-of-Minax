...
namespace Server.Mobiles
{
    ...
    public class SHRandomRobot : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomRobot() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomRobot(Serial serial) : base(serial)
        {
        }
