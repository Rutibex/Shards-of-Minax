...
namespace Server.Mobiles
{
    ...
    public class SHRandomFey : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomFey() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomFey(Serial serial) : base(serial)
        {
        }
