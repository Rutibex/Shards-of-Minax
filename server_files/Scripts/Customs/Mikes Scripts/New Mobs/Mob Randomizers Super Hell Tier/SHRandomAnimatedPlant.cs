...
namespace Server.Mobiles
{
    ...
    public class SHRandomAnimatedPlant : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomAnimatedPlant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomAnimatedPlant(Serial serial) : base(serial)
        {
        }
