...
namespace Server.Mobiles
{
    ...
    public class SHRandomCanine : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomCanine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomCanine(Serial serial) : base(serial)
        {
        }
