...
namespace Server.Mobiles
{
    ...
    public class SHRandomDragon : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomDragon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomDragon(Serial serial) : base(serial)
        {
        }
