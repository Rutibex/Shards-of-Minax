...
namespace Server.Mobiles
{
    ...
    public class SHRandomRodent : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomRodent() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomRodent(Serial serial) : base(serial)
        {
        }
