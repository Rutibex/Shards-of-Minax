...
namespace Server.Mobiles
{
    ...
    public class SHRandomMinotaur : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomMinotaur() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomMinotaur(Serial serial) : base(serial)
        {
        }
