...
namespace Server.Mobiles
{
    ...
    public class SHRandomKnightLord : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomKnightLord() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomKnightLord(Serial serial) : base(serial)
        {
        }
