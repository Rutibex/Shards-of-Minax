...
namespace Server.Mobiles
{
    ...
    public class SHRandomOrc : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomOrc() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomOrc(Serial serial) : base(serial)
        {
        }
