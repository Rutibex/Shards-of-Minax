...
namespace Server.Mobiles
{
    ...
    public class SHRandomSlime : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomSlime() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomSlime(Serial serial) : base(serial)
        {
        }
