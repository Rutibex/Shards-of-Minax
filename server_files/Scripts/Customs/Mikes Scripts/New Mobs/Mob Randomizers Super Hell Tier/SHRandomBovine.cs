...
namespace Server.Mobiles
{
    ...
    public class SHRandomBovine : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomBovine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomBovine(Serial serial) : base(serial)
        {
        }
