...
namespace Server.Mobiles
{
    ...
    public class SHRandomPig : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomPig() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomPig(Serial serial) : base(serial)
        {
        }
