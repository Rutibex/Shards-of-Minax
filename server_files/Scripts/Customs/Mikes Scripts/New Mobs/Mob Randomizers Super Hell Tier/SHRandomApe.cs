...
namespace Server.Mobiles
{
    ...
    public class SHRandomApe : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomApe() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomApe(Serial serial) : base(serial)
        {
        }
