...
namespace Server.Mobiles
{
    ...
    public class SHRandomRuminant : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomRuminant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomRuminant(Serial serial) : base(serial)
        {
        }
