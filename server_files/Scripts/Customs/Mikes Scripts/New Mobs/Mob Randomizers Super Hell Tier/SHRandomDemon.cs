...
namespace Server.Mobiles
{
    ...
    public class SHRandomDemon : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomDemon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomDemon(Serial serial) : base(serial)
        {
        }
