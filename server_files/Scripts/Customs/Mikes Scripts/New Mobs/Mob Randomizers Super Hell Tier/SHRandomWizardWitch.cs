...
namespace Server.Mobiles
{
    ...
    public class SHRandomWizardWitch : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomWizardWitch() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomWizardWitch(Serial serial) : base(serial)
        {
        }
