...
namespace Server.Mobiles
{
    ...
    public class SHRandomBear : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomBear() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomBear(Serial serial) : base(serial)
        {
        }
