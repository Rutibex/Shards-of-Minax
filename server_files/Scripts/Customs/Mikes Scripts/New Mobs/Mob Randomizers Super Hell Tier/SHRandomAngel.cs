...
namespace Server.Mobiles
{
    ...
    public class SHRandomAngel : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomAngel() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomAngel(Serial serial) : base(serial)
        {
        }
