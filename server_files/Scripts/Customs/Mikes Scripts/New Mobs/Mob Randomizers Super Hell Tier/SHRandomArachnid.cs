...
namespace Server.Mobiles
{
    ...
    public class SHRandomArachnid : BaseCreature
    {
        ...
        [Constructable]
        public SHRandomArachnid() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SHRandomArachnid(Serial serial) : base(serial)
        {
        }
