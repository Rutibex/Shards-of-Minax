...
{
    [CorpseName("corpse of a unique robot")]
    public class NMRandomRobot : BaseCreature
    {
        private static readonly int[] robotBodies = new int[] { 0x2F5, 0x2FB, 0x2F4, 0x2F0, 0x300, 0x304, 0x2FF }; // Robot and cyborg body values
        private static readonly string[] wordBank1 = new string[]
        {
			...
			"Sinister", "Menacing", "Ominous", "Ferocious", "Erratic",
			"Uncanny", "Eerie", "Gloomy", "Fearsome", "Mysterious",
			"Obsolete", "Forbidden", "Cursed", "Misguided", "Rogue",
			"Rebel", "Notorious", "Defiant", "Unyielding", "Shadowy",
			"Relentless", "Invincible", "Formidable", "Intrepid", "Heroic",
			"Luminous", "Enigmatic", "Spectral", "Haunting", "Arcane",
			"Primordial", "Sage", "Courageous", "Resilient", "Daring",
			"Fabled", "Chimeric", "Bewitching", "Stoic", "Venerable",
			"Sinister", "Foreboding", "Intimidating", "Volatile", "Aberrant",
			"Paranormal", "Creepy", "Dreadful", "Terrifying", "Elusive",
			"Outdated", "Prohibited", "Jinxed", "Wayward", "Renegade",
			"Infamous", "Combative", "Inflexible", "Clandestine"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Bot", "Droid", "Cyborg", "Automaton", "Mechanoid",
            "Robot", "Android", "Gynoid", "Machine", "Construct",
			"Mech", "Cybernetic", "Replicant", "Synthetic", "Artificer",
			"Automata", "Technorganic", "Bio-bot", "Nanobot", "Cyborgian",
			"Exomachina", "Steelman", "Borg", "Cyberling", "Mechanimal",
			"Mechtron", "Cybernaut", "Roboid", "Synthebot", "Technomancer",
			"BioMech", "NanoCyborg", "CyberBeast", "SteelGolem", "CyberSpecter",
			"RoboWarrior", "AndroidAssassin", "CyberPhoenix", "MechaRider", "TechnoGiant",
			"BioSteel", "NanoDroid", "CyberWraith", "SteelSentinel", "CyberCentaur",
			"RoboTitan", "AndroidMage", "CyberDragon", "MechaSerpent", "TechnoHydra",
			"Techbot", "Cyberdroid", "Bio-cyborg", "Mechatron", "Robo-human",
			"Synthebot", "Cyber-android", "Nanomech", "Bio-construct", "Cyborg-ling",
			"Exo-robot", "Steel-droid", "Cyber-borg", "Mecha-beast", "Robo-animal",
			"Synthetic-organism", "Techno-human", "Bio-mech", "Cyber-construct", "Robo-creature",
			"Exo-automaton", "Steel-golem", "Cyber-entity", "Mecha-humanoid", "Robo-synthetic"
        };
        ...
        [Constructable]
        public NMRandomRobot() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = robotBodies[Utility.Random(robotBodies.Length)];
        ...
        public NMRandomRobot(Serial serial) : base(serial)
        {
        }
