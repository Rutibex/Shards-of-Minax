...
namespace Server.Mobiles
{
    ...
    public class NMRandomRidable : BaseMount
    {
        private static readonly int[] ridableBodies = new int[] { 0xC8, 0x123, 0xCC, 0xBE, 0x7A, 0xDC, 0x124, 793, 0x31F, 188, 187, 0x20E1, 243, 132, 243, 793, 0xDA, 0xDB, 0x2D96, 0xD2,  }; // Horse and llama body values
		private static readonly string[] wordBank1 = new string[]
        {
			...
			"Regal", "Regnant",
			"Nimble", "Vibrant", "Noble", "Ethereal", "Proud",
			"Majestic", "Steadfast", "Tranquil", "Resolute", "Venerable",
			"Epic", "Astral", "Celestial", "Eternal", "Pristine",
			"Illustrious", "Exalted", "Harmonious", "Immutable", "Serene",
			"Resilient", "Imperial", "Sovereign", "Dauntless", "Spirited",
			"Intrepid", "Majestic", "Invincible", "Fabled", "Phantom",
			"Shadow", "Mirage", "Phenomenal", "Mystical", "Infinite",
			"Boundless", "Eclipse", "Luminous", "Dazzling", "Splendid",
			"Immaculate", "Glorious", "Supreme", "Dominant", "Victorious",
			"Renowned", "Peerless", "Titanic", "Monarch", "Sage",
			"Divine", "Heroic", "Legendary", "Arcane", "Enigmatic",
			"Phenomenal", "Zenith", "Ascendant", "Paramount", "Spectral",
			"Tempest", "Ingenious", "Vivid", "Untamed", "Venerable",
			"Exuberant", "Aurora", "Cosmic", "Galactic", "Celestial"
        };
        ...
        private static readonly string[] wordBank2 = new string[]
        {
			...
			"Andalusian", "Percheron", "Thoroughbred", "Hackney", "Shire",
			"Warmblood", "Hanoverian", "Tennessee Walker", "Quarter Horse", "Paint",
			"Connemara", "Haflinger", "Akhal-Teke", "Lipizzan", "Morgan",
			"Welsh Pony", "Paso Fino", "Irish Cob", "American Saddlebred", "Miniature",
			"Lusitano", "Standardbred", "Mule", "Draft Horse", "Barb",
			"Bashkir Curly", "Gypsy Vanner", "Criollo", "Camargue", "Pony of the Americas",
			"Brumby", "Cob", "Gypsy", "Highlander", "Icelandic",
			"Jennet", "Kiger", "Leopard", "Mustang", "Narragansett Pacer",
			"Orlov Trotter", "Przewalski", "Quarab", "Rocky Mountain", "Sable",
			"Tarpan", "Ukrainian Riding Horse", "Vlaamperd", "Waler", "Xilingol",
			"Yakut", "Zweibrucker", "Belgian", "Cleveland Bay", "Dales",
			"Exmoor", "Falabella", "Grulla", "Hackamore", "Iberian",
			"Jutland", "Knabstrupper", "Lokai", "Marwari", "Noriker",
			"Oldenburg", "Piebald", "Rabicano", "Selle Francais", "Tobiano",
			"Unicorn", "Ventasso Horse", "Welara", "Xenophon", "Yonaguni",
			"Zangersheide", "Ardennes", "Buckskin", "Crioulo", "Dun"
        };
        ...
        [Constructable]
        public NMRandomRidable() : base("a unique mount", Utility.RandomList(ridableBodies), Utility.RandomList(ridableBodies), AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public NMRandomRidable(Serial serial) : base(serial)
        {
        }
