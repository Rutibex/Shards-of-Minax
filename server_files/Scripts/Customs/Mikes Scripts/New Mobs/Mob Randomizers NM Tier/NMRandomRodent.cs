...
{
    [CorpseName("corpse of a unique rodent")]
    public class NMRandomRodent : BaseCreature
    {
        private static readonly int[] rodentBodies = new int[] { 0xCD, 0xD7, 0xEE, 0x116,0x117, 0x2A  }; // Rodent body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Cute", "Furry", "Squeaky", "Cheeky", "Nibbly",
            "Fluffy", "Tiny", "Adorable", "Chubby", "Sniffy",
            "Spunky", "Curious", "Playful", "Friendly", "Smart",
            "Scurry", "Whisker", "Bouncy", "Fuzzy", "Wiggly",
			"Snuggly", "Quirky", "Silky", "Jolly", "Lively",
			"Nippy", "Perky", "Jumpy", "Peppy", "Zippy",
			"Flouncy", "Giggly", "Cuddly", "Perky", "Dinky",
			"Frolicsome", "Frisky", "Pipsqueak", "Plucky", "Zesty",
			"Spirited", "Sprightly", "Silly", "Nimble", "Bubbly",
			"Spry", "Pert", "Blinky", "Sunny", "Sassy",
			"Ticklish", "Chipper", "Twinkly", "Dizzy", "Fiddle",
			"Glimmer", "Blossom", "Giddy", "Glint", "Sparky",
			"Snappy", "Snazzy", "Bounce", "Whimsy", "Fiddle",
			"Flitter", "Zingy", "Pizzazz", "Dandy", "Peachy",
			"Twirly", "Merry", "Skippy", "Gleeful", "Pudgy",
			"Velvety", "Bright", "Glossy", "Chipper", "Vivacious",
			"Brisk", "Twitchy", "Darting", "Jovial", "Prancing",
			"Mirthful", "Wistful", "Dainty", "Vibrant", "Swift",
			"Blithe", "Whirly", "Pixie", "Mischief", "Rascally",
			"Scamper", "Dapper", "Windy", "Merry", "Tricky",
			"Roly-Poly", "Tumbly", "Beaming", "Hopping", "Dewy",
			"Crinkly", "Twinkle", "Rustic", "Scuttle", "Hustle",
			"Bundle", "Wander", "Tangle", "Bluster", "Crafty",
			"Ramble", "Bounder", "Jester", "Fleet", "Muddle",
			"Looper", "Scoot", "Amble", "Doodle", "Flicker"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Mouse", "Rat", "Hamster", "Gerbil", "Guinea Pig",
            "Squirrel", "Chipmunk", "Beaver", "Hedgehog", "Porcupine",
            "Mole", "Vole", "Shrew", "Lemming", "Muskrat",
            "Chinchilla", "Degu", "Dormouse", "Gopher", "Marmot",
			"Jerboa", "Kangaroo Rat", "Prairie Dog", "Pocket Gopher", "Naked Mole Rat",
			"Rock Hyrax", "Desert Rat", "Wood Rat", "Tree Shrew", "Bandicoot",
			"Coypu", "Water Vole", "Capybara", "Pocket Mouse", "Pika",
			"Springhare", "Bamboo Rat", "Brushtail Possum", "Meadow Vole", "Marsh Rat",
			"Numbat", "Quoll", "Rabbit Rat", "Ringtail", "Solenodon",
			"Sunda Colugo", "Tarsier", "Tasmanian Devil", "Yellow-Spotted Climbing Mouse", "Rock Cavy",
			"Moonrat", "Mongoose Lemur", "Golden Mole", "Desert Pocket Mouse", "Fat Dormouse",
			"Gambian Pouched Rat", "Pouched Mouse", "Desert Hedgehog", "Long-Tailed Chinchilla", "Palm Squirrel",
			"Hyrax", "Rodent Shrew", "African Pygmy Mouse", "Grass Rat", "Pouched Rat",
			"Pygmy Jerboa", "Rodent Mermaid", "Tundra Vole", "Yellow-Spotted Climbing Mouse", "Woodland Vole",
			"Vole Mouse", "Forest Gerbil", "Steppe Mouse", "Canyon Mouse", "Glacier Rat",
			"Cloud Rat", "Dwarf Hamster", "Rainforest Squirrel", "Boreal Vole", "Alpine Marmot",
			"Marsh Beaver", "Paddy Rat", "Crested Porcupine", "Bushy-Tailed Woodrat", "Snowshoe Hare",
			"Spiny Mouse", "Cave Mole", "Sky Island Chipmunk", "Swamp Muskrat", "Taiga Lemming",
			"Brush Mouse", "Field Vole", "Harvest Mouse", "Heath Rat", "Island Mouse",
			"Jungle Rat", "Meadow Mouse", "Night Rat", "Oasis Mouse", "Pine Squirrel",
			"River Otter", "Sand Rat", "Scrub Rat", "Sea Vole", "Silky Pocket Mouse",
			"Slate-Colored Vole", "Spotted Gerbil", "Stripe-Tailed Rat", "Tawny Rat", "Urban Mouse",
			"Valley Pocket Gopher", "Wetland Rat", "Woodland Mouse", "Yellow-Footed Antechinus", "Zebra Mouse",
			"Arctic Lemming", "Bamboo Lemur", "Cactus Mouse", "Dune Mole Rat", "Eurasian Beaver"
        };
        ...
        [Constructable]
        public NMRandomRodent() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = rodentBodies[Utility.Random(rodentBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyCheese());
        ...
        public NMRandomRodent(Serial serial) : base(serial)
        {
        }
