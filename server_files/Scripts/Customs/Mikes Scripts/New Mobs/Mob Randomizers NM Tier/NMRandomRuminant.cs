...
namespace Server.Mobiles
{
    ...
    public class NMRandomRuminant : BaseCreature
    {
        private static readonly int[] ridableBodies = new int[] { 0xD1, 0x58, 0xCF, 0xDF, 0xED, 0xEA, 0xDC }; // Ruminant body values
        private static readonly string[] wordBank1 = new string[]
        {
			...
			"Delightful", "Affectionate", "Amiable", "Affable", "Sociable",
			"Endearing", "Enchanting", "Pleasant", "Genial", "Kindhearted",
			"Heartwarming", "Winsome", "Sociable", "Amicable", "Chirpy",
			"Merry", "Contented", "Jovial", "Blithe", "Buoyant",
			"Sprightly", "Vivacious", "Animated", "Radiant", "Sunny",
			"Whimsical", "Serene", "Tranquil", "Graceful", "Majestic",
			"Silky", "Elegant", "Nimble", "Spry", "Dainty",
			"Jolly", "Zesty", "Quirky", "Gleeful", "Frolicsome",
			"Peppy", "Lively", "Zippy", "Exuberant", "Effervescent",
			"Sparkling", "Twinkling", "Shining", "Glowing", "Beaming",
			"Bright", "Lustrous", "Dazzling", "Brilliant", "Vibrant",
			"Sturdy", "Robust", "Hardy", "Stalwart", "Valiant",
			"Swift", "Quick", "Agile", "Speedy", "Fast",
			"Plucky", "Bold", "Adventurous", "Courageous", "Dauntless",
			"Resourceful", "Ingenious", "Inventive", "Clever", "Witty"
        };
        ...
        private static readonly string[] wordBank2 = new string[]
        {
			...
			"Reindeer", "Caribou", "Ox", "Stag", "Hartebeest",
			"Chamois", "Muskox", "Nilgai", "Springbok", "Oryx",
			"Addax", "Bongo", "Barbary", "Waterbuck", "Topi",
			"Sable", "Gnu", "Quagga", "Sitatunga", "Lechwe",
			"Kob", "Duiker", "Goral", "Markhor", "Bharal",
			"Thar", "Mouflon", "Argali", "Takin", "Saola",
			"Dik-dik", "Roan", "Gerenuk", "Puku", "Nyala",
			"Klipspringer", "Oribi", "Steenbok", "Sunni", "Tsessebe",
			"Aoudad", "Four-horned", "Guemal", "Hirola", "Kiang",
			"Tahr", "Urial", "Vicuña", "Zebu", "Blackbuck",
			"Kouprey", "Serow", "Takin", "Vaal", "Zeren",
			"Brocket", "Calamian", "Dorcas", "Hangul", "Javan",
			"Kudu", "Marsh", "Nubian", "Pronghorn", "Roe",
			"Sambar", "Tibetan", "Water", "White-tailed", "Blue",
			"Brown", "Grey", "Ibex", "Jackalope", "Knob"
        };
        ...
        [Constructable]
        public NMRandomRuminant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public NMRandomRuminant(Serial serial) : base(serial)
        {
        }
