...
namespace Server.Mobiles
{
    ...
    public class NMRandomKnightLord : BaseCreature
    {
        ...
        [Constructable]
        public NMRandomKnightLord() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public NMRandomKnightLord(Serial serial) : base(serial)
        {
        }
