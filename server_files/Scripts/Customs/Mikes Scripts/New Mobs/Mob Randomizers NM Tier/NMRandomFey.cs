...
{
    [CorpseName("corpse of a unique fey")]
    public class NMRandomFey : BaseCreature
    {
        private static readonly int[] feyBodies = new int[] { 0x65, 0x108, 0x309, 0x10A, 0xF7, 0x80, 0xB0, 0xF0, 0xF6, 0x10F, 0xDD, 0x4A, 0xFF, 0xFD, 0xF5, 0x30B, 0x1E, 0x1F, 0x308, 0x27 }; // Fey body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Shimmering", "Glimmering", "Sparkling", "Luminous", "Radiant",
			"Enchanted", "Magical", "Mystical", "Whimsical", "Fanciful",
			"Ethereal", "Celestial", "Astral", "Arcane", "Divine",
			"Dreamy", "Wondrous", "Miraculous", "Marvelous", "Fantastic",
			"Enigmatic", "Enrapturing", "Spellbinding", "Otherworldly", "Spectacular",
			"Enchanted", "Mesmerizing", "Enthralling", "Transcendent", "Illustrious",
			"Phantasmal", "Supernatural", "Bewitching", "Charmed", "Wonderstruck",
			"Enlightened", "Breathtaking", "Sublime", "Resplendent", "Beauteous",
			"Radiant", "Glittering", "Dazzling", "Spellbound", "Glorious",
			"Captivating", "Elysian", "Exquisite", "Radiating", "Mythical",
			"Iridescent", "Ephemeral", "Incandescent", "Seraphic", "Empyreal",
			"Ineffable", "Luminescent", "Majestic", "Mystifying", "Omnipotent",
			"Perpetual", "Prismatic", "Quintessential", "Rhapsodic", "Sanctified",
			"Tenebrous", "Ubiquitous", "Unearthly", "Venerable", "Wistful",
			"Zephyr", "Auroral", "Blissful", "Celestine", "Delightful",
			"Euphoric", "Fey", "Gossamer", "Harmonious", "Immutable",
			"Jubilant", "Kaleidoscopic", "Lyrical", "Mellifluous", "Nostalgic",
			"Oasis", "Pristine", "Querencia", "Rapture", "Sylvan",
			"Tranquil", "Utopian", "Vigilant", "Whimsy", "Xanadu",
			"Yielding", "Zenith", "Affable", "Bucolic", "Chimerical"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Sprite", "Pixie", "Fairy", "Nymph", "Sylph",
			"Dryad", "Naiad", "Oread", "Faun", "Satyr",
			"Puck", "Brownie", "Leprechaun", "Imp", "Gnome",
			"Elf", "Siren", "Mermaid", "Selkie", "Nixie",
			"Changeling", "Undine", "Will-o'-the-Wisp", "Grig", "Kelpie",
			"Elfin", "Sidhe", "Troll", "Banshee", "Djinn",
			"Kobold", "Tylwyth Teg", "Pixy", "Goblin", "Hobgoblin",
			"Spriggan", "Silkie", "Lorelei", "Asrai", "Ghillie Dhu",
			"Pooka", "Alf", "Dullahan", "Fylgja", "Leshy",
			"Menehune", "Nisse", "Peri", "Qilin", "Rusalka",
			"Salamander", "Tomte", "Uruku", "Valkyrie", "Wight",
			"Xana", "Yuki-onna", "Zephyr Spirit", "Aether Sprite", "Boggart",
			"Cu Sith", "Drake", "Echo Nymph", "Frost Wight", "Grove Guardian"
        };
        ...
        [Constructable]
        public NMRandomFey() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = feyBodies[Utility.Random(feyBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyInstrument());
        ...
        public NMRandomFey(Serial serial) : base(serial)
        {
        }
