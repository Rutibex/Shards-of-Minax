...
{
    [CorpseName("corpse of a unique demon")]
    public class NMRandomDemon : BaseCreature
    {
        private static readonly int[] demonBodies = new int[] { 0x310, 0xF2, 0x134, 0x318, 0x9, 0x26, 0x66, 0x139, 0x13E, 0x2EA, 0x31C, 0x132, 0x4A, 0x100, 0x13A, 0x11D, 0xF9, 0xF8, 0x13C, 0xFB, 0xFA, 0x30A, 0xAE, 0x95, 0x314, 0x12E, 0x92, 0x137, 0x315, 0x307, 0x3E7, 0x13F, 0x103, 0x27, 0xF6, 0x308, 0x31B, 0x133, 0x13B, 0x30C, 0x138  }; // Demon body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Vile", "Wicked", "Malicious", "Cruel", "Ferocious",
			"Savage", "Fiery", "Bloody", "Sinister", "Dreadful",
			"Infernal", "Diabolic", "Malevolent", "Nefarious", "Abominable",
			"Horrific", "Terrifying", "Monstrous", "Devastating", "Ruthless",
			"Cursed", "Twisted", "Eldritch", "Spiteful", "Corrupted",
			"Screaming", "Blighted", "Noxious", "Putrid", "Ghastly",
			"Gruesome", "Macabre", "Eerie", "Creeping", "Demonic",
			"Haunted", "Hateful", "Baleful", "Venomous", "Wretched",
			"Morbid", "Grim", "Ghoulish", "Maleficent", "Frightful",
			"Sinister", "Murderous", "Diseased", "Malignant", "Shadowed",
			"Vicious", "Venal", "Unholy", "Toxic", "Spectral",
			"Ravenous", "Pernicious", "Ominous", "Nightmarish", "Mystic",
			"Lurking", "Invisible", "Insidious", "Heinous", "Gnarled",
			"Enraged", "Dreaded", "Desecrated", "Cataclysmic", "Baneful",
			"Abyssal", "Writhing", "Vengeful", "Unspeakable", "Thorned",
			"Shadowy", "Revolting", "Petrifying", "Obscure", "Malign",
			"Lethal", "Infernal", "Harrowing", "Grisly", "Foul",
			"Exiled", "Doomed", "Darkened", "Chilling", "Bewitched",
			"Ancient", "Withered", "Unearthly", "Tainted", "Sullen",
			"Ritualistic", "Primeval", "Necrotic", "Malefic", "Loathsome"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Demon", "Fiend", "Beast", "Spawn", "Scourge",
			"Hellion", "Imp", "Devil", "Daemon", "Tormentor",
			"Destroyer", "Reaper", "Slayer", "Bane", "Wrath",
			"Fury", "Flame", "Blaze", "Inferno", "Nightmare",
			"Malevolence", "Bringer", "Pestilence", "Terror", "Specter",
			"Phantom", "Shade", "Abomination", "Carnage", "Chaos",
			"Desolation", "Doom", "Vengeance", "Havoc", "Pain",
			"Rage", "Sorrow", "Tyrant", "Torturer", "Plague",
			"Death", "Madness", "Despair", "Treachery", "Perdition",
			"Darkness", "Vortex", "Frenzy", "Ruination", "Decay",
			"Apparition", "Blight", "Curse", "Dread", "Entity",
			"Fiendish", "Ghoul", "Harbinger", "Illusion", "Jinx",
			"Knight", "Lich", "Mimic", "Nymph", "Oracle",
			"Poltergeist", "Quarry", "Revenant", "Spirit", "Tempest",
			"Undertow", "Valkyrie", "Wraith", "Xenolith", "Yeti",
			"Zephyr", "Arcane", "Banshee", "Crypt", "Doppelganger",
			"Ectoplasm", "Frostbite", "Gargoyle", "Hex", "Ichor",
			"Juggernaut", "Kraken", "Labyrinth", "Maelstrom", "Nexus",
			"Omen", "Pyre", "Quagmire", "Rift", "Serpent",
			"Throne", "Umbra", "Vortex", "Wanderer", "Xenomorph",
			"Yawning", "Zealot"
        };
        ...
        [Constructable]
        public NMRandomDemon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = demonBodies[Utility.Random(demonBodies.Length)];
			...
			PackItem(new DaemonBone(Utility.RandomMinMax(10, 50))); // Demons drop daemon bones
        ...
        public NMRandomDemon(Serial serial) : base(serial)
        {
        }
