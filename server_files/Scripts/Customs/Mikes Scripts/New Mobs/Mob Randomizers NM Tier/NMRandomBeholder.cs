...
{
    [CorpseName("corpse of a unique beholder")]
    public class NMRandomBeholder : BaseCreature
    {
        private static readonly int[] beholderBodies = new int[] { 0x16, 0x44, 0x45 }; // Beholder body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Evil", "Mad", "Cruel", "Vile", "Wicked",
			"Malicious", "Sinister", "Dreadful", "Horrid", "Foul",
			"Dark", "Grim", "Savage", "Ferocious", "Ruthless",
			"Merciless", "Bloodthirsty", "Vicious", "Malevolent", "Diabolic",
			"Fiendish", "Spiteful", "Nefarious", "Monstrous", "Satanic",
			"Scheming", "Murderous", "Terrifying", "Malignant", "Barbaric",
			"Shadowy", "Infamous", "Atrocious", "Abominable", "Hellish",
			"Infernal", "Pernicious", "Horrifying", "Wretched", "Perfidious",
			"Depraved", "Demonic", "Sinister", "Cursed", "Draconian",
			"Maleficent", "Insidious", "Grotesque", "Abhorrent", "Loathsome",
			"Blighted", "Unholy", "Ghastly", "Tyrannical", "Desolate",
			"Harsh", "Baleful", "Heinous", "Revolting", "Ominous",
			"Venomous", "Toxic", "Pestilent", "Calamitous", "Gruesome",
			"Impious", "Sullen", "Brutal", "Corrupt", "Defiled",
			"Unrelenting", "Wrathful", "Dire", "Eerie", "Macabre",
			"Obscene", "Pitiless", "Rancorous", "Sardonic", "Turbulent",
			"Vengeful", "Warped", "Zephyrous", "Yawning", "Xenophobic",
			"Wanton", "Volatile", "Ungodly", "Traitorous", "Sorcerous",
			"Rabid", "Quarrelsome", "Putrid", "Oppressive", "Noxious"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Eye", "Gaze", "Glare", "Stare", "Vision",
			"Sight", "Look", "Watch", "Blink", "Wink",
			"Orb", "Sphere", "Ball", "Globe", "Circle",
			"Lens", "Iris", "Pupil", "Cornea", "Retina",
			"Eyeball", "Optic", "Observation", "Peepers", "Beholder",
			"View", "Scry", "Oculus", "Spectacle", "Glimpse",
			"Aspect", "Peek", "Gander", "Scout", "Perception",
			"Apparatus", "Aperture", "Occult", "Stalk", "Glint",
			"Twinkle", "Glimmer", "Spark", "Flash", "Beam",
			"Radiance", "Glitter", "Twilight", "Dusk", "Dawn",
			"Mirage", "Appraisal", "Surveillance", "Watcher", "Survey",
			"Inspection", "Leer", "Scrutiny", "Observatory", "Sentry",
			"Outlook", "Panorama", "Vista", "Surveyor", "Recon",
			"Monitor", "Detector", "Spectator", "Viewer", "Witness",
			"Scoper", "Spotter", "Seer", "Revealer", "Discerner",
			"Visionary", "Predictor", "Prophet", "Soothsayer", "Augur",
			"Clairvoyant", "Diviner", "Oracle", "Psychic", "Sage",
			"Seeress", "Voyeur", "Watcher", "Beholden", "Noticer",
			"Perceiver", "Recognizer", "Identifier", "Detector", "Espier"
        };
        ...
        [Constructable]
        public NMRandomBeholder() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = beholderBodies[Utility.Random(beholderBodies.Length)];
        ...
        public NMRandomBeholder(Serial serial) : base(serial)
        {
        }
