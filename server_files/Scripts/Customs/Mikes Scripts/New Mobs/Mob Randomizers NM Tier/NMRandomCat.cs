...
{
    [CorpseName("corpse of a unique cat")]
    public class NMRandomCat : BaseCreature
    {
        private static readonly int[] ridableBodies = new int[] { 0x3F, 0xC9 }; // Cat body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Fluffy", "Cute", "Sassy", "Lucky", "Shadow",
            "Ginger", "Snowy", "Misty", "Whiskers", "Ninja",
            "Fuzzy", "Spooky", "Cookie", "Bella", "Simba",
            "Luna", "Oreo", "Zoe", "Milo", "Chloe",
			"Whisper", "Smokey", "Pumpkin", "Midnight", "Paws",
			"Tiger", "Cinnamon", "Pebbles", "Snuggles", "Freckles",
			"Marshmallow", "Mittens", "Muffin", "Peaches", "Pebbles",
			"Shadow", "Socks", "Sunny", "Tigger", "Willow",
			"Cocoa", "Copper", "Daisy", "Gizmo", "Honey",
			"Jasper", "Maple", "Mocha", "Peaches", "Pumpkin",
			"Rosie", "Sable", "Sapphire", "Sky", "Smudge",
			"Socks", "Sunny", "Tiger", "Vanilla", "Violet",
			"Zeus", "Ziggy", "Zippy", "Zorro", "Zuzu",
			"Amber", "Angel", "Ashes", "Blossom", "Bubbles",
			"Basil", "Blizzard", "Caramel", "Chestnut", "Clover",
			"Cobweb", "Comet", "Cricket", "Dandelion", "Drizzle",
			"Ember", "Fern", "Glitter", "Harbor", "Ivy",
			"Jingle", "Kale", "Lavender", "Leaf", "Licorice",
			"Mango", "Marble", "Meadow", "Nectar", "Nutmeg",
			"Olive", "Parsley", "Quartz", "Raven", "Ripple",
			"Sage", "Sequoia", "Sorrel", "Sparkle", "Speckle",
			"Spirit", "Sprout", "Storm", "Thistle", "Thunder",
			"Twinkle", "Velvet", "Whirlwind", "Wisp", "Zen",
			"Acorn", "Aurora", "Breeze", "Brook", "Buttercup"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Cat", "Kitty", "Kitten", "Feline", "Tabby",
            "Tomcat", "Moggy", "Puss", "Pussy", "Mouser",
            "Siamese", "Persian", "Maine Coon", "Sphynx", "Bengal",
            "Ragdoll", "British Shorthair", "Scottish Fold", "Norwegian Forest", "Russian Blue",
			"Bobtail", "Calico", "Cuddles", "Gingerbread", "Lynx",
			"Merlin", "Mittens", "Moonbeam", "Nibbles", "Peanut",
			"Pumpkin", "Rascal", "Shadow", "Shamrock", "Silhouette",
			"Skittles", "Snickers", "Snickerdoodle", "Snugglebug", "Starlight",
			"Sunshine", "Sweetie", "Tinker", "Twilight", "Whisker",
			"Willow", "Waffles", "Bluebell", "Butterscotch", "Chip",
			"Freckle", "Fudge", "Marbles", "Petal", "Pixie",
			"Princess", "Sable", "Sprinkles", "Truffle", "Velvet",
			"Blossom", "Buttons", "Doodle", "Misty", "MooMoo",
			"Nutmeg", "Peaches", "Popcorn", "Scooter", "Toffee",
			"Charm", "Cheer", "Cloud", "Companion", "Crumb",
			"Dazzle", "Dream", "Duchess", "Elf", "Empress",
			"Enchant", "Fairy", "Gem", "Glimmer", "Goblin",
			"Harmony", "Heir", "Imp", "Jester", "Jewel",
			"Knight", "Legend", "Locket", "Lore", "Majesty",
			"Miracle", "Muse", "Mystery", "Nimbus", "Noble",
			"Oracle", "Paladin", "Phantom", "Prince", "Quest",
			"Realm", "Reverie", "Rogue", "Sage", "Seraph",
			"Sprite", "Squire", "Tale", "Throne", "Token",
			"Valor", "Vision", "Whim", "Wizard", "Zenith",
			"Bliss", "Echo", "Frost", "Glow", "Halo"
        };
        ...
        [Constructable]
        public NMRandomCat() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public NMRandomCat(Serial serial) : base(serial)
        {
        }
