...
{
    [CorpseName("corpse of a unique gargoyle")]
    public class NMRandomGargoyle : BaseCreature
    {
        private static readonly int[] gargoyleBodies = new int[] { 0x4, 0x2F2, 0x2F3, 0x2F6, 0x2F1, 0x43 }; // Gargoyle body values
        private static readonly string[] wordBank1 = new string[]
        {
			...
			"Regal", "Formidable", "Heroic", "Intrepid", "Magnificent",
			"Splendid", "Imposing", "Courageous", "Spectral", "Arcane",
			"Timeless", "Sagacious", "Mystical", "Legendary", "Resolute",
			"Fearless", "Unyielding", "Watchful", "Luminous", "Ethereal",
			"Proud", "Gallant", "Dignified", "Imperial", "Steadfast",
			"Exalted", "Luminous", "Supernatural", "Stoic", "Invincible",
			"Venerable", "Magical", "Sage", "Indomitable", "Unflinching",
			"Majestic", "Awe-inspiring", "Dauntless", "Resilient", "Shimmering",
			"Monumental", "Towering", "Enigmatic", "Sacred", "Sentinel",
			"Solitary", "Silent", "Ineffable", "Unearthly", "Transcendent",
			"Immutable", "Inscrutable", "Eternal", "Celestial", "Otherworldly",
			"Proud", "Valorous", "Gallant", "Dignified", "Imperial",
			"Exalted", "Glorious", "Invincible", "Unflinching", "Steadfast",
			"Enduring", "Eternal", "Sage", "Magical", "Lionhearted",
			"Dauntless", "Majesty", "Awe-inspiring", "Towering", "Majestic",
			"Venerable", "Stoic", "Solitary", "Silent", "Mysterious",
			"Enigmatic", "Inscrutable", "Ineffable", "Arcane", "Esoteric",
			"Sacred", "Hallowed", "Consecrated", "Blessed", "Divine"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Gargoyle", "Stonebeast", "Grotesque", "Demon", "Fiend",
            "Monster", "Creature", "Beast", "Horror", "Terror",
            "Nightmare", "Chimera", "Hellspawn", "Goyle", "Statue",
			"Stoneguard", "Grotesquery", "Shadowbeast", "Fright", "Apparition",
			"Critter", "Brute", "Phantasm", "Dread", "Panic",
			"Specter", "Gorgon", "Hellhound", "Gargol", "Effigy",
			"Stonewarden", "Gargantua", "Grotesquery", "Demonspawn", "FiendishFigure",
			"Monstrosity", "Behemoth", "Horrorgoyle", "Terrorwing", "Nightstalker",
			"Dreamhaunter", "Chimerabeast", "Hellishhound", "Gargoyleguard", "Stoneeffigy",
			"Shadowgoyle", "Frightfiend", "Apparitionbeast", "Crittergoyle", "Brutegargoyle",
			"Phantasmhorror", "Dreadgargoyle", "Panicbeast", "Spectergoyle", "Gorgongargoyle",
			"Stonefigure", "Gargantua", "Grotesquery", "Demonspawn", "Fiendishform",
			"Monstrosity", "Cryptid", "Behemoth", "Horrorshow", "Terrorform",
			"Nightstalker", "Chimerical", "Hellion", "Gargoylian", "Effigyform",
			"Stonewarden", "Grotesquebeast", "Shadowspawn", "Frightform", "Phantom",
			"Critterbeast", "Brutishform", "Phantasmal", "Dreadbeast", "Panicform",
			"Spectralform", "Gorgonian", "Hellbeast", "Gargoylesque", "Statuesque"
        };
        ...
        [Constructable]
        public NMRandomGargoyle() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = gargoyleBodies[Utility.Random(gargoyleBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyCrystal());
        ...
        public NMRandomGargoyle(Serial serial) : base(serial)
        {
        }
