...
{
    [CorpseName("corpse of a unique angel")]
    public class NMRandomAngel : BaseCreature
    {
		private static readonly int[] angelBodies = new int[] { 0x7B, 0xAF, 0x3A }; // Angel body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Radiant", "Glorious", "Heavenly", "Divine", "Celestial",
            "Exalted", "Seraphic", "Ethereal", "Holy", "Sacred",
            "Immaculate", "Pure", "Luminous", "Resplendent", "Venerable",
            "Blessed", "Enlightened", "Glorified", "Sanctified", "Transcendent",
			"Effulgent", "Sublime", "Exalted", "Elysian", "Beatific",
			"Numinous", "Resplendent", "Unblemished", "Sacrosanct", "Hallowed",
			"Inviolate", "Virginal", "Illumined", "Transfigured", "Exalted",
			"Ineffable", "Majestic", "Omniscient", "Omnipotent", "Benevolent",
			"Venerated", "Adored", "Idolized", "Glorified", "Exalted",
			"Radiant", "Brilliant", "Shining", "Gleaming", "Sparkling",
			"Luminescent", "Splendid", "Exquisite", "Supreme", "Transcendent",
			"Elysian", "Beatific", "Celestial", "Sacrosanct", "Venerated",
			"Consecrated", "Impeccable", "Radiant", "Resplendent", "Divine",
			"Enlightened", "Glorious", "Hallowed", "Inviolable", "Majestic",
			"Omnipresent", "Sovereign", "Sublime", "Transcendent", "Unblemished",
			"Virtuous", "Benign", "Eminent", "Exalted", "Inviolate",
			"Magnificent", "Omnibenevolent", "Preeminent", "Supreme", "Transfigured",
			"Unblemished", "Venerable", "Adored", "Revered", "Sacred"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Angel", "Seraph", "Cherub", "Archangel", "Guardian",
            "Messenger", "Protector", "Heron", "Virtue", "Power",
            "Principality", "Dominion", "Throne", "Choir", "Host",
            "Heaven", "Paradise", "Eden", "Zion", "Empyrean",
			"Apsara", "Deva", "Gandharva", "Kinnara", "Valkyrie",
			"Bodhisattva", "Jinn", "Obun", "Amadis", "Iris",
			"Peri", "Nephilim", "Grigori", "Aeon", "Orisha",
			"Tiānshì", "Kami", "Hesperus", "Phosphorus", "Dyaus",
			"Avatar", "Daeva", "Elohim", "Fravashi", "Gabriel",
			"Haniel", "Iblis", "Jana", "Kirin", "Lailah",
			"Metatron", "Norn", "Ophanim", "Phoenix", "Qadishtu",
			"Raphael", "Sylph", "Taranis", "Uriel", "Vishvakarman",
			"Winged", "Xanadu", "Yazata", "Ziz", "Astra",
			"Baihu", "Camaxtli", "Dakini", "Elohim", "Fylgja",
			"Garuda", "Hathor", "Izanagi", "Jurojin", "Kalki",
			"Lamassu", "Mazu", "Nut", "Obatala", "Pazuzu"
        };
        ...
        [Constructable]
        public NMRandomAngel() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = angelBodies[Utility.Random(angelBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFruitBasket());
        ...
        public NMRandomAngel(Serial serial) : base(serial)
        {
        }
