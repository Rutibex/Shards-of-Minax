...
{
    [CorpseName("corpse of a unique snake")]
    public class NMRandomSnake : BaseCreature
    {
        private static readonly int[] snakeBodies = new int[] { 0x34, 0x15, 0x88, 0x89, 0x57 }; // Snake body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Venomous", "Slithering", "Coiled", "Fanged", "Constricting",
			"Serpentine", "Scaly", "Hissing", "Cunning", "Sinister",
			"Viper", "Cobra", "Python", "Rattler", "Mamba",
			"Asp", "Anaconda", "Boa", "Coral", "Copperhead",
			"Vicious", "Sly", "Lurking", "Twisted", "Silent",
			"Shadow", "Grim", "Slytherin", "Dark", "Death",
			"Obsidian", "Nightshade", "Venomfang", "Sable", "Shadowstrike",
			"Grimcoil", "Deadly", "Nightstalker", "Silentdeath", "Dread",
			"Black", "Dusk", "Moonshadow", "Ebon", "Darkling",
			"Gloomscale", "Twilight", "Moonlit", "Shadowfang", "Nether",
			"Whispering", "Envenomed", "Swift", "Baleful", "Lethal",
			"Reclusive", "Stalking", "Pit", "Tiger", "Specter",
			"Ruthless", "Chilling", "Ember", "Phantom", "Infernal",
			"Gorgon", "Basilisk", "Wyrm", "Shade", "Mystic",
			"Arctic", "Blazing", "Cryptic", "Dire", "Ethereal",
			"Fiery", "Glacial", "Harbinger", "Invisible", "Jade",
			"Krait", "Luminous", "Marbled", "Nocturnal", "Ophidian",
			"Plague", "Quicksilver", "Rampant", "Stygian", "Tempest",
			"Umbral", "Vorpal", "Wraith", "Xenon", "Zephyr"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Fang", "Spike", "Bite", "Strike", "Wrath",
			"Squeeze", "Crush", "Poison", "Venom", "Spit",
			"Tail", "Coil", "Slither", "Hiss", "Rattle",
			"Scale", "Skin", "Shed", "Glide", "Swallow",
			"Toxin", "Gnash", "Tear", "Pierce", "Snap",
			"Serpent", "Vengeance", "Doom", "Fury", "Grimace",
			"Shadow", "Lurker", "Maw", "Voracity", "Constrictor",
			"Jaws", "Venomstrike", "Slink", "Silence", "Nightfall",
			"Deathcoil", "Viperbite", "Gloom", "Sable", "Darkness",
			"Eclipse", "Terror", "Dread", "Moonshadow", "Abyss",
			"Claw", "Ambush", "Lash", "Maim", "Snare",
			"Engulf", "Imprison", "Quake", "Thorn", "Blizzard",
			"Flame", "Gale", "Harpoon", "Inferno", "Javelin",
			"Kiss", "Lightning", "Mist", "Nemesis", "Orbit",
			"Plasma", "Quiver", "Rampage", "Surge", "Torrent",
			"Uproot", "Vortex", "Whirl", "Exile", "Yield",
			"Zap", "Arc", "Blast", "Chill", "Drift",
			"Eclipse", "Frostbite", "Ghoul", "Howl", "Ire"
        };
        ...
        [Constructable]
        public NMRandomSnake() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = snakeBodies[Utility.Random(snakeBodies.Length)];
        ...
        public NMRandomSnake(Serial serial) : base(serial)
        {
        }
