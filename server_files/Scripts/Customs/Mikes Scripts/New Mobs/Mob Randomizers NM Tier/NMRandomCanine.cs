...
{
    [CorpseName("corpse of a unique canine")]
    public class NMRandomCanine : BaseCreature
    {
        private static readonly int[] canineBodies = new int[] { 0xD9, 0x61, 0x62, 0x63, 0x17, 0x19, 0x1B }; // Canine body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Furry", "Loyal", "Friendly", "Ferocious", "Cute",
			"Fluffy", "Smart", "Playful", "Alert", "Savage",
			"Faithful", "Adorable", "Brutal", "Clever", "Cheerful",
			"Fierce", "Gentle", "Happy", "Nimble", "Spunky",
			"Wild", "Protective", "Energetic", "Curious", "Affectionate",
			"Bold", "Agile", "Strong", "Mysterious", "Gracious",
			"Courageous", "Caring", "Vigilant", "Independent", "Spirited",
			"Charming", "Kind", "Swift", "Robust", "Loving",
			"Majestic", "Dynamic", "Vibrant", "Sociable", "Eager",
			"Fearless", "Alert", "Wise", "Foxy", "Zesty",
			"Tenacious", "Luminous", "Resilient", "Trusting", "Diligent",
			"Radiant", "Intrepid", "Stoic", "Valiant", "Dapper",
			"Noble", "Sleek", "Witty", "Rugged", "Astute",
			"Keen", "Daring", "Lush", "Thrifty", "Svelte",
			"Crafty", "Sturdy", "Sincere", "Jovial", "Plucky",
			"Optimistic", "Pristine", "Innovative", "Punctual", "Graceful",
			"Vivid", "Earnest", "Dauntless", "Philosophical", "Quirky",
			"Rustic", "Serene", "Venerable", "Whimsical", "Zealous",
			"Omniscient", "Ubiquitous", "Xenial", "Youthful", "Zany",
			"Empathetic", "Idyllic", "Jubilant", "Kaleidoscopic", "Legendary"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Dog", "Pup", "Hound", "Wolf", "Fox",
			"Mutt", "Pooch", "Canine", "Mongrel", "Corgi",
			"Husky", "Labrador", "Beagle", "Poodle", "Terrier",
			"Shepherd", "Mastiff", "Spaniel", "Retriever", "Dachshund",
			"Alsatian", "Collie", "Pomeranian", "Greyhound", "Boxer",
			"Chihuahua", "Great Dane", "Schnauzer", "Bulldog", "Pitbull",
			"Dalmatian", "Shih Tzu", "Basset Hound", "Border Collie", "Bichon Frise",
			"Jack Russell", "Saint Bernard", "Pekingese", "Whippet", "Australian Shepherd",
			"Golden Retriever", "Shiba Inu", "English Setter", "Irish Wolfhound", "Afghan Hound",
			"Samoyed", "Akita", "Bloodhound", "Papillon", "Basenji",
			"Malinois", "Doberman", "Vizsla", "Weimaraner", "Pointer",
			"Maltese", "Yorkie", "Newfoundland", "Rottweiler", "Sheltie",
			"Cavalier", "Cockapoo", "Labradoodle", "Goldendoodle", "Bernese",
			"Norfolk Terrier", "Rat Terrier", "Silky Terrier", "Tibetan Mastiff", "Lhasa Apso",
			"Brittany", "Coonhound", "Malamute", "Norwich Terrier", "Otterhound",
			"Puggle", "Rhodesian Ridgeback", "Saluki", "Toy Fox Terrier", "Wire Fox Terrier",
			"Belgian Tervuren", "Chow Chow", "Clumber Spaniel", "Finnish Spitz", "Giant Schnauzer",
			"Harrier", "Italian Greyhound", "Keeshond", "Komondor", "Kuvasz",
			"Leonberger", "Lowchen", "Neapolitan Mastiff", "Norwegian Elkhound", "Nova Scotia Duck Tolling Retriever",
			"Old English Sheepdog", "Pharaoh Hound", "Presa Canario", "Pyrenean Shepherd", "Redbone Coonhound"
        };
        ...
        [Constructable]
        public NMRandomCanine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = canineBodies[Utility.Random(canineBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyDinner());
        ...
        public NMRandomCanine(Serial serial) : base(serial)
        {
        }
