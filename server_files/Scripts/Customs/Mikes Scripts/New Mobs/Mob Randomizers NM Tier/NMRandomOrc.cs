...
{
    [CorpseName("corpse of a unique orc")]
    public class NMRandomOrc : BaseCreature
    {
        private static readonly int[] orcBodies = new int[] { 0x11, 0xB6, 0x7, 0x8A, 0xBD, 0xB5, 0x8C, 0x29 }; // Orc body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Brutal", "Ferocious", "Savage", "Ruthless", "Relentless",
            "Bloodthirsty", "Menacing", "Formidable", "Intimidating", "Terrifying",
            "Monstrous", "Colossal", "Gigantic", "Towering", "Hulking",
            "Massive", "Enormous", "Gargantuan", "Titanic", "Behemoth",
			"Fierce", "Vicious", "Brutish", "Barbaric", "Unyielding",
			"Cruel", "Harsh", "Severe", "Punishing", "Ominous",
			"Gargantuan", "Herculean", "Brobbingnagian", "Goliath", "Gigantesque",
			"Immense", "Prodigious", "Tremendous", "Voluminous", "Gargantuan"

        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Warrior", "Berserker", "Raider", "Marauder", "Plunderer",
            "Pillager", "Invader", "Conqueror", "Destroyer", "Annihilator",
            "Exterminator", "Obliterators", "Devastator", "Ravager", "Slaughterer",
            "Butcher", "Executioner", "Assassin", "Hunter", "Predator",
			"Gladiator", "Vanguard", "Warlord", "Reaver", "Harbinger",
			"Despoiler", "Usurper", "Subjugator", "Dismantler", "Eradicator",
			"Decimator", "Extirpator", "Demolisher", "Wreckers", "Slayer",
			"Chopper", "Terminator", "Sniper", "Stalker", "Beast"
        };
        ...
        [Constructable]
        public NMRandomOrc() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = orcBodies[Utility.Random(orcBodies.Length)];
        ...
        public NMRandomOrc(Serial serial) : base(serial)
        {
        }
