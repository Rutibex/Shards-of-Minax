...
{
    [CorpseName("corpse of a unique animated plant")]
    public class NMRandomAnimatedPlant : BaseCreature
    {
        private static readonly int[] plantBodies = new int[] { 0x8, 0x2F }; // Animated tree and plant body values

        private static readonly string[] wordBank1 = new string[]
        {
            "Ancient", "Enchanted", "Mystic", "Twisted", "Gnarled",
            "Vibrant", "Lush", "Thorny", "Blooming", "Radiant",
			"Whispering", "Majestic", "Ethereal", "Spiraled", "Knotted",
			"Flourishing", "Verdeant", "Prickly", "Blossoming", "Glowing",
			"Sacred", "Enchanting", "Arcane", "Contorted", "Tangled",
			"Bustling", "Fertile", "Spiny", "Flowering", "Shimmering",
			"Humming", "Imposing", "Celestial", "Coiled", "Intertwined",
			"Prosperous", "Verdant", "Brambly", "Budding", "Luminous",
			"Sage", "Mystical", "Entwined", "Verdurous", "Thriving",
			"Rustling", "Regal", "Otherworldly", "Spiral", "Snarled",
			"Teeming", "Fruitful", "Barbed", "Sprouting", "Beaming",
			"Divine", "Captivating", "Esoteric", "Distorted", "Matted",
			"Booming", "Productive", "Thorned", "Budding", "Illuminated",
			"Hallowed", "Bewitching", "Cryptic", "Curled", "Mingled",
			"Flourishing", "Emerald", "Prickled", "Flowered", "Gleaming",
			"Murmuring", "Dominant", "Heavenly", "Wound", "Tied"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Oak", "Maple", "Pine", "Cedar", "Birch",
            "Willow", "Rosebush", "Ivy", "Fern", "Cactus",
			"Hickory", "Beech", "Spruce", "Cypress", "Elm",
			"Magnolia", "Lavender", "Moss", "Daisy", "Succulent",
			"Sequoia", "Hemlock", "Ash", "Walnut", "Chestnut",
			"Hazel", "Holly", "Jasmine", "Orchid", "Aloe",
			"Sycamore", "Linden", "Mahogany", "Teak", "Yew",
			"Lilac", "Heather", "Lichen", "Tulip", "Euphorbia",
			"Bamboo", "Hawthorn", "Juniper", "Mulberry", "Pecan",
			"Poplar", "Sagebrush", "Vine", "Wisteria", "Yucca",
			"Acacia", "Balsam", "Cherry", "Dogwood", "Fig",
			"Ginkgo", "Honeysuckle", "Juniper", "Kauri", "Larch",
			"Mangrove", "Nectarine", "Olive", "Palm", "Quince",
			"Redwood", "Sassafras", "Tamarind", "Umbrella Tree", "Violet",
			"Waterlily", "Xerophyte", "Yarrow", "Zinnia", "Azalea"
        };
        ...
        [Constructable]
        public NMRandomAnimatedPlant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = plantBodies[Utility.Random(plantBodies.Length)];
        ...
        public NMRandomAnimatedPlant(Serial serial) : base(serial)
        {
        }
