...
{
    [CorpseName("corpse of a unique undead")]
    public class NMRandomUndead : BaseCreature
    {
        private static readonly int[] undeadBodies = new int[] { 0x18, 0x1A, 0x32, 0x38, 0x39, 0x94, 0x9A, 0x9B, 0x136, 0x10B, 0x319, 0x105, 0x92, 0x137, 0x3CA, 0x135, 0x134 }; // Undead body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Doomed", "Cursed", "Ghastly", "Shadow", "Rotten",
			"Forsaken", "Dread", "Spectral", "Wicked", "Vile",
			"Noxious", "Sinister", "Malevolent", "Sullen", "Grim",
			"Morbid", "Blighted", "Eerie", "Macabre", "Grave",
			"Putrid", "Decayed", "Haunting", "Spiteful", "Demonic",
			"Unholy", "Twisted", "Infernal", "Deathly", "Bleak",
			"Wretched", "Skeletal", "Horrific", "Hateful", "Cadaverous",
			"Baneful", "Dire", "Dreadful", "Foul", "Gory",
			"Hideous", "Maleficent", "Monstrous", "Nefarious", "Rotting",
			"Sickening", "Sinister", "Vicious", "Vengeful", "Voracious",
			"Spirit", "Zombie", "Skeleton", "Wraith", "Phantom",
			"Ghoul", "Mummy", "Specter", "Revenant", "Corpse",
			"Fiend", "Shade", "Ghost", "Banshee", "Lich",
			"Necromancer", "Cryptkeeper", "Vampire", "Warlock", "Sorcerer",
			"Abomination", "Apparition", "Deathlord", "Doombringer", "Hellspawn",
			"Nightmare", "Plaguebearer", "Rotwalker", "Soulhunter", "Terror",
			"Undertaker", "Voidwalker", "Wight", "Demon", "Darkling",
			"Gravekeeper", "Netherfiend", "Catacomb", "Desecrator", "Eldritch",
			"Fleshrender", "Grimreaper", "Shadowfiend", "Tormentor", "Vexation",
			"Woebringer", "Dreadlord", "Frostwraith", "Pestilence", "Suffering"
        };
        ...
        private static readonly string[] wordBank2 = new string[]
        {
			...
			"Fleshrender", "Grimreaper", "Shadowfiend", "Tormentor", "Vexation",
			"Woebringer", "Dreadlord", "Frostwraith", "Pestilence", "Suffering",
			"Blightspawn", "Cairn", "Draugr", "Ectoplasm", "Fantom",
			"Ghast", "Haunt", "Imp", "Juggernaut", "Kraken",
			"Lurker", "Marauder", "Nighthawk", "Ogre", "Poltergeist",
			"Quagmire", "Ripper", "Spook", "Thrall", "Umbra",
			"Valkyrie", "Wendigo", "Xylophage", "Yeti", "Zephyr",
			"Archfiend", "Bonefletcher", "Cryptlord", "Duskbringer", "Ether",
			"Gargoyle", "Hydra", "Inferno", "Jinx", "Kobold",
			"Leviathan", "Mimic", "Necropolis", "Oblivion", "Pitlord",
			"Quicksilver", "Runegeist", "Scourge", "Tombstalker", "Umbral",
			"Vortex", "Wraithlord", "Xenomorph", "Yeth Hound", "Zombie Lord"
        };
        ...
        [Constructable]
        public NMRandomUndead() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = undeadBodies[Utility.Random(undeadBodies.Length)];
			...
			PackItem(new RandomFancyBakedGoods());
        ...
        public NMRandomUndead(Serial serial) : base(serial)
        {
        }
