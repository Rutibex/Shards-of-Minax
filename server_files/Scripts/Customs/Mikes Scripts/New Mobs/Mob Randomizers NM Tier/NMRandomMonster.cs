...
{
    [CorpseName("corpse of a unique creature")]
    public class NMRandomMonster : BaseCreature
    {

		private static string[] wordBank1 = new string[]
        {
            "Ancient", "Venomous", "Infernal", "Mystic", "Cursed",
            "Spectral", "Savage", "Giant", "Tiny", "Vicious",
            "Primeval", "Frozen", "Fiery", "Shadowy", "Radiant",
            "Ethereal", "Corrupted", "Arcane", "Armored", "Ravenous",
            "Toxic", "Celestial", "Abyssal", "Thunderous", "Primal",
            "Enchanted", "Ghastly", "Invisible", "Feral", "Undying",
            "Stone", "Iron", "Crystal", "Elder", "Blighted",
            "Warped", "Tainted", "Icy", "Burning", "Shimmering",
            "Dreaded", "Solemn", "Wicked", "Luminous", "Hallowed",
            "Frostbitten", "Stormborn", "Venom", "Majestic", "Barbaric",
			"Bloodthirsty", "Runic", "Metallic", "Glowing", "Dark",
			"Twisted", "Furious", "Divine", "Demonic", "Royal",
			"Revenant", "Mutated", "Flaming", "Frozen", "Stormy",
			"Plated", "Spiked", "Horned", "Winged", "Fanged",
			"Scaly", "Feathered", "Furry", "Slimy", "Bony",
			"Crystalline", "Molten", "Magnetic", "Electric", "Acidic",
			"Explosive", "Nuclear", "Mechanical", "Cybernetic", "Biological",
			"Psychic", "Telekinetic", "Telepathic", "Illusory", "Dream",
			"Nightmare", "Phantom", "Mirage", "Elemental", "Planar",
			"Temporal", "Spatial", "Astral", "Cosmic", "Quantum",
			"Zarthon", "Xylian", "Vorax", "Umbra", "Tharion",
			"Synth", "Ryza", "Quark", "Plex", "Orius",
			"Nix", "Myra", "Lynx", "Kryx", "Jade",
			"Ixion", "Hex", "Gyra", "Fyre", "Exo",
			"Drex", "Cyra", "Byron", "Axel", "Zephyr",
			"Yara", "Wrex", "Vega", "Tyra", "Sylph",
			"Rune", "Pyre", "Nova", "Mira", "Lyra",
			"Kira", "Jinx", "Iris", "Helix", "Gale",
			"Frost", "Eris", "Drake", "Cora", "Blaze"

        };

        private static string[] wordBank2 = new string[]
        {
            "Behemoth", "Serpent", "Dragon", "Wraith", "Golem",
            "Basilisk", "Vampire", "Chimera", "Hydra", "Griffin",
            "Sphinx", "Kraken", "Manticore", "Wyrm", "Phoenix",
            "Troll", "Goblin", "Ogre", "Lich", "Zombie",
            "Specter", "Wolf", "Bear", "Eagle", "Raven",
            "Hawk", "Lion", "Tiger", "Elephant", "Rhino",
            "Unicorn", "Pegasus", "Minotaur", "Cyclops", "Ghoul",
            "Sprite", "Fairy", "Djinn", "Nymph", "Harpy",
            "Centaur", "Werewolf", "Mermaid", "Leviathan", "Dragonfly",
            "Salamander", "Cobra", "Falcon", "Roc", "Naga",
			"Scorpion", "Spider", "Bat", "Rat", "Snake",
			"Crocodile", "Shark", "Whale", "Octopus", "Squid",
			"Crab", "Lobster", "Shrimp", "Jellyfish", "Starfish",
			"Seahorse", "Dolphin", "Piranha", "Eel", "Turtle",
			"Beetle", "Butterfly", "Moth", "Ant", "Bee",
			"Wasp", "Hornet", "Fly", "Mosquito", "Mantis",
			"Grasshopper", "Caterpillar", "Worm", "Slug", "Snail",
			"Monkey", "Gorilla", "Orangutan", "Chimpanzee", "Lemur",
			"Koala", "Kangaroo", "Platypus", "Hedgehog", "Porcupine",
			"Skunk", "Raccoon", "Squirrel", "Chipmunk", "Beaver",
			"Zarcon", "Xylon", "Vortex", "Ursa", "Thrax",
			"Syrix", "Ryker", "Quill", "Pluto", "Orion",
			"Nyx", "Myron", "Lux", "Kraken", "Jax",
			"Ixar", "Hawk", "Gyron", "Fyra", "Eon",
			"Dracon", "Cyrus", "Byron", "Axon", "Zenon",
			"Yara", "Wrath", "Vex", "Tyro", "Sylar",
			"Ryza", "Pyro", "Nora", "Mira", "Lynx",
			"Kyro", "Jade", "Ivan", "Halo", "Gala",
			"Flare", "Era", "Draco", "Cora", "Blade"
        };
        ...
        [Constructable]
        public NMRandomMonster() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = Utility.RandomMinMax(1, 319);
        ...
        public NMRandomMonster(Serial serial) : base(serial)
        {
        }
