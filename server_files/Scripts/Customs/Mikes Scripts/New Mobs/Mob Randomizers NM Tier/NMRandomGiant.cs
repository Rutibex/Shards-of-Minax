...
{
    [CorpseName("corpse of a unique giant")]
    public class NMRandomGiant : BaseCreature
    {
        private static readonly int[] giantBodies = new int[] { 0x2, 0x12, 0x1, 0xBD, 0x4C, 0x35, 0x37, 0x36, 0x31C }; // Giant body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Furious", "Massive", "Colossal", "Savage", "Mighty",
            "Terrifying", "Monstrous", "Enormous", "Fearsome", "Powerful",
            "Ancient", "Mythic", "Enchanted", "Wise", "Valiant",
            "Bold", "Legendary", "Stalwart", "Vigilant", "Radiant",
			"Raging", "Thundering", "Ruthless", "Thunderous", "Apocalyptic",
			"Dreaded", "Immense", "Vast", "Incredible", "Menacing",
			"Mythical", "Fearless", "Majestic", "Noble", "Steadfast",
			"Indomitable", "Resolute", "Unyielding", "Heroic", "Formidable",
			"Mysterious", "Unstoppable", "Roaring", "Destructive", "Unrelenting",
			"Vicious", "Untamed", "Wild", "Brutal", "Searing",
			"Blazing", "Ferocious", "Venomous", "Sinister", "Foreboding",
			"Demonic", "Sinister", "Eternal", "Boundless", "Timeless",
			"Primordial", "Omnipotent", "Epic", "Ethereal", "Infernal",
			"Celestial", "Mythological", "Dreadful", "Mythic", "Imposing",
			"Unfathomable", "Towering", "Gargantuan", "Shadowy", "Luminous",
			"Primal", "Turbulent", "Stormy", "Cataclysmic", "Wrathful",
			"Stoic", "Dauntless", "Inscrutable", "Arcane", "Mystical",
			"Primeval", "Almighty", "Spectral", "Celestial", "Galactic",
			"Phantom", "Revered", "Shrouded", "Tempestuous", "Abyssal",
			"Guardian", "Elder", "Supreme", "Invisible", "Invincible",
			"Phenomenal", "Immutable", "Sovereign", "Necrotic", "Astral",
			"Divine", "Exalted", "Hallowed", "Inferno", "Cryptic",
			"Oblivion", "Phantasmal", "Sylvan", "Tempered", "Twilight",
			"Umbral", "Venerable", "Wandering", "Zephyr", "Expedient",
			"Fractal", "Glacial", "Harbinger", "Immutable", "Juggernaut"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Giant", "Titan", "Behemoth", "Jotun", "Ogre",
            "Cyclops", "Goliath", "Nephilim", "Leviathan", "Kraken",
            "Troll", "Yeti", "Bigfoot", "Abominable", "Snowman",
            "Gargantua", "Atlas", "Hercules", "Polyphemus", "Antaeus",
			"Dragon", "Mammoth", "Colossus", "Orc", "Gorgon",
			"Wraith", "Phoenix", "Sphinx", "Basilisk", "Centaur",
			"Minotaur", "Hydra", "Chimera", "Griffin", "Cerberus",
			"Wyvern", "Cyclopean", "Demigod", "Godzilla", "Quetzalcoatl",
			"Megalodon", "Kaiju", "Roc", "Pegasus", "Cthulhu",
			"Djinn", "Ent", "Harpy", "Thunderbird", "Manticore",
			"Frost Giant", "Fire Giant", "Storm Giant", "Mountain Giant", "Dark Titan",
			"Star Titan", "Shadow Titan", "Moon Titan", "Sun Titan", "Earth Titan",
			"Ocean Titan", "Sky Titan", "Chaos Titan", "Doom Titan", "Void Titan",
			"Abyssal Titan", "Nether Titan", "Eclipse Titan", "Astral Titan", "Elder Titan"
        };
        ...
        [Constructable]
        public NMRandomGiant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = giantBodies[Utility.Random(giantBodies.Length)];
        ...
        public NMRandomGiant(Serial serial) : base(serial)
        {
        }
