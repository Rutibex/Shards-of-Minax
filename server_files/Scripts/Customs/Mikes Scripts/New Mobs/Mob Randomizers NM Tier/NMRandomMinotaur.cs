...
{
    [CorpseName("corpse of a unique minotaur")]
    public class NMRandomMinotaur : BaseCreature
    {
        private static readonly int[] minotaurBodies = new int[] { 0x107, 0x118, 0x106 }; // Minotaur body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Mighty", "Ferocious", "Savage", "Brutal", "Fearsome",
            "Terrifying", "Formidable", "Intimidating", "Menacing", "Powerful",
			"Gigantic", "Enormous", "Majestic", "Imposing", "Ruthless",
			"Invincible", "Indomitable", "Relentless", "Ominous", "Monstrous",
			"Colossal", "Tremendous", "Vast", "Gargantuan", "Massive",
			"Gigantic", "Towering", "Daunting", "Threatening", "Overwhelming",
			"Unstoppable", "Invulnerable", "Intractable", "Implacable", "Herculean",
			"Savage", "Barbaric", "Wild", "Untamed", "Fierce",
			"Magnificent", "Unyielding", "Domineering", "Overpowering", "Titanic",
			"Gargantuan", "Gigantic", "Prodigious", "Stupendous", "Hulking",
			"Gargantuan", "Towering", "Daunting", "Intimidating", "Overwhelming",
			"Unstoppable", "Invincible", "Unconquerable", "Insurmountable", "Indestructible",
			"Mighty", "Robust", "Stalwart", "Redoubtable", "Herculean",
			"Savage", "Brutal", "Ruthless", "Pitiless", "Remorseless",
			"Fierce", "Ferocious", "Wild", "Untamed", "Unruly",
			"Awe-inspiring", "Behemoth", "Brawny", "Colossal", "Daunting",
			"Dreadful", "Feared", "Gargantuan", "Gigantic", "Hulking",
			"Imposing", "Indestructible", "Invincible", "Majestic", "Mighty",
			"Ominous", "Overpowering", "Powerful", "Relentless", "Rugged",
			"Stalwart", "Stupendous", "Terrifying", "Titanic", "Unconquerable",
			"Unyielding", "Vast", "Vigorous", "Wild", "Wrathful",
			"Zealous", "Bold", "Brutal", "Domineering", "Fearsome",
			"Intimidating", "Menacing", "Overwhelming", "Remorseless", "Ruthless",
			"Stormy", "Thunderous", "Unstoppable", "Violent", "Warlike",
			"Belligerent", "Ferocious", "Fierce", "Formidable", "Indomitable",
			"Intractable", "Implacable", "Robust", "Unruly", "Untamed"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Minotaur", "Beast", "Monster", "Creature", "Fiend",
            "Demon", "Brute", "Goliath", "Titan", "Colossus",
			"Herculean", "Juggernaut", "Leviathan", "Mammoth", "Nemesis",
			"Bull-Man", "Half-Breed", "Horned-Beast", "Labyrinth-Dweller", "Maze-Monster",
			"Mythical-Creature", "Nightmare", "Ogre", "Rager", "Savage-Beast",
			"Taurus", "Terror", "The-Bull", "The-HornedOne", "The-Minotaur",
			"The-Monster", "The-Nightmare", "The-Terror", "The-WildBeast", "Wild-Bull"
        };
        ...
        [Constructable]
        public NMRandomMinotaur() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = minotaurBodies[Utility.Random(minotaurBodies.Length)];
        ...
        public NMRandomMinotaur(Serial serial) : base(serial)
        {
        }
