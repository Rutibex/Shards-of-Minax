...
{
    [CorpseName("corpse of a unique insect")]
    public class NMRandomInsect : BaseCreature
    {
        private static readonly int[] creatureBodies = new int[] { 0x317, 0xF4, 0x30 }; // Beetle and scorpion body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Swift", "Majestic", "Noble", "Gallant", "Fierce",
			"Creepy", "Crawly", "Repulsive", "Disgusting", "Revolting",
			"Frightening", "Terrifying", "Horrid", "Grotesque", "Hideous",
			"Loathsome", "Detestable", "Abhorrent", "Odious", "Nauseating",
			"Vile", "Wretched", "Despicable", "Hateful", "Malevolent",
            "Elegant", "Graceful", "Brave", "Spirit", "Mystic",
            "Ancient", "Mythic", "Enchanted", "Wise", "Valiant",
            "Bold", "Legendary", "Stalwart", "Vigilant", "Radiant",
			"Valorous", "Heroic", "Gallant", "Dignified", "Regal",
			"Magnificent", "Splendid", "Glorious", "Intrepid", "Courageous",
			"Timeless", "Arcane", "Magical", "Sage", "Lionhearted",
			"Fearless", "Renowned", "Resolute", "Watchful", "Luminous",
			"Agile", "Imposing", "Stately", "Chivalrous", "Formidable",
			"Eerie", "Uncanny", "Repugnant", "Offensive", "Repellent",
			"Chilling", "Alarming", "Dreadful", "Ghastly", "Ugly",
			"Repulsive", "Hateful", "Deplorable", "Abominable", "Sickening",
			"Vicious", "Miserable", "Contemptible", "Spiteful", "Sinister",
			"Poised", "Charming", "Courageous", "Soulful", "Mystical",
			"Primordial", "Fabled", "Charmed", "Insightful", "Chivalrous",
			"Daring", "Famed", "Steadfast", "Vigilant", "Shining",
			"Dauntless", "Gallant", "Respected", "Majestic", "Exalted",
			"Impressive", "Brilliant", "Triumphant", "Audacious", "Boldhearted",
			"Unfearing", "Distinguished", "Determined", "Attentive", "Beaming"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Beetle", "Scorpion", "Scarab", "Arachnid", "Insect",
			"StagBeetle", "HerculesBeetle", "DungBeetle", "Firefly", "Cricket",
			"Grasshopper", "Mantis", "Cicada", "Dragonfly", "WalkingStick",
			"Weevil", "Spider", "Ant", "Moth", "Butterfly",
			"RhinocerosBeetle", "AtlasBeetle", "JuneBeetle", "Ladybug", "Katydid",
			"PrayingMantis", "Locust", "Leafhopper", "Damselfly", "StickInsect",
			"LonghornBeetle", "TigerBeetle", "WaterBeetle", "GroundBeetle", "ClickBeetle",
			"BombardierBeetle", "DivingBeetle", "JewelBeetle", "LightningBug", "Earwig",
			"Termite", "Flea", "Lacewing", "Mayfly", "Stonefly",
			"Aphid", "Caddisfly", "Silverfish", "Springtail", "Thrips",
			"Dobsonfly", "Mantisfly", "Sawfly", "Snakefly", "Webspinner",
			"Glowworm", "Hoverfly", "Mealybug", "Midge", "ScaleInsect",
			"Stinkbug", "WalkingLeaf", "Wasp", "Woodlouse", "Zorapteran"
        };
        ...
        [Constructable]
        public NMRandomInsect() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = creatureBodies[Utility.Random(creatureBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyStatue());
        ...
        public NMRandomInsect(Serial serial) : base(serial)
        {
        }
