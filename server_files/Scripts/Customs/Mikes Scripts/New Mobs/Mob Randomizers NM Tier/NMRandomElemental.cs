...
{
    [CorpseName("corpse of a unique elemental")]
    public class NMRandomElemental : BaseCreature
    {

        private static string[] elementNames = new string[]
        {
            // Add all periodic elements you wish to include here
            "Hydrogen", "Helium", "Lithium", "Beryllium", "Boron",
            "Carbon", "Nitrogen", "Oxygen", "Fluorine", "Neon",
            "Sodium", "Magnesium", "Aluminum", "Silicon", "Phosphorus",
            "Sulfur", "Chlorine", "Argon", "Potassium", "Calcium",
            // Continue adding element names...
            "Iron", "Gold", "Copper", "Silver", "Zinc",
            "Mercury", "Lead", "Platinum", "Tin", "Nickel",
            "Xenon", "Uranium", "Plutonium",
			"Hydrogen", "Helium", "Lithium", "Beryllium", "Boron",
            "Carbon", "Nitrogen", "Oxygen", "Fluorine", "Neon",
            "Sodium", "Magnesium", "Aluminum", "Silicon", "Phosphorus",
            "Sulfur", "Chlorine", "Argon", "Potassium", "Calcium",
            "Iron", "Gold", "Copper", "Silver", "Zinc",
            "Mercury", "Lead", "Platinum", "Tin", "Nickel",
            "Xenon", "Uranium", "Plutonium", "Diamond", "Graphite",
            "Amber", "Obsidian", "Ice", "Steam", "Mud",
            "Lava", "Wood", "Ether", "Shadow", "Light",
            "Myst", "Crystal", "Silk", "Wine", "Oil",
            "Sand", "Glass", "Smoke", "Coral", "Pearl",
            "Bone", "Flesh", "Leather", "Paper", "Cobalt",
            "Ruby", "Sapphire", "Emerald", "Quartz", "Amethyst",
            "Topaz", "Onyx", "Ivory", "Brass", "Bronze",
            "Steel", "Mithril", "Adamantite", "Electrum", "Obsidian",
			"Aether", "Void", "Nebula", "Plasma", "Ectoplasm",
            "Mana", "Aurora", "Vortex", "Quicksilver", "Etherwind",
            "Stardust", "Black Hole", "White Dwarf", "Dark Matter", "Antimatter",
            "Dream Essence", "Chaos Energy", "Time Fabric", "Soulstone", "Phantom Mist",
            "Arcane Crystal", "Lightning Glass", "Moon Shard", "Sunfire", "Shadowflame",
            "Mirage", "Whisperwind", "Thunderclap", "Starlight", "Voidstone",
            "Galaxy Marble", "Dimensional Silk", "Eclipse", "Nether", "Spirit Quartz",
            "Cosmic Dust", "Astral Beam", "Gravity Well", "Psychic Wave", "Radiant Eclipse",
            "Temporal Shift", "Mystic Ice", "Fire Opal", "Celestial Pearl", "Warpwood",
            "Thunderstone", "Solar Flare", "Lunar Glow", "Quantum Field", "Ether Frost",
            "Necrotic Leather", "Infernal Ash", "Primordial Soup", "Cosmic Web", "Void Salt",
			"Water", "Blood", "Mercury", "Acid", "Lava",
            "Milk", "Honey", "Wine", "Oil", "Quicksilver",
            "Potion", "Mana", "Vinegar", "Ink", "Mud",
            "Elixir", "Sap", "Tea", "Coffee", "SeaWater",
            "Brine", "Alcohol", "Ether", "Nectar", "Poison",
            "Ichor", "Tincture", "Bile", "Goo", "Slime",
            "Magma", "Broth", "Juice", "LiquidGold", "LiquidSilver",
            "LiquidCrystal", "LiquidFire", "LiquidShadow", "LiquidLight", "LiquidPlatinum",
            "Spirit", "Essence", "LiquidNitrogen", "LiquidOxygen", "LiquidHydrogen",
            "Plasma", "GalacticWater", "AetherFlow", "DarkMatter", "NeutronFluid",
            "StardustSolution", "VoidLiquid", "TimeDrops", "DreamDew", "ChaosSyrup",
			"Vibranium", "Adamantium", "Kryptonite", "Energon", "Nth Metal",
            "Protoculture", "Unobtainium", "Tiberium", "Phazon", "Lyrium",
            "Element Zero", "Naquadah", "Isogen", "Red Matter", "Liquid Adamantium",
            "Tritium", "Dilithium", "Thaumium", "Mako Energy", "Nova Crystals",
            "Omnigel", "Saronite", "Azoth", "Soma", "Dark Matter",
            "Dark Energy", "Orichalcum", "Mythril", "Aether", "Dragonstone",
            "Soulsteel", "Voidstone", "Chaos Emeralds", "Lifestream", "Blackrock",
            "Fel Iron", "True Iron", "Saronite", "Cortosis", "Beskar",
            "Phrik", "Durasteel", "Carbonite", "Vibro", "Eridium",
            "Slag", "Iridium", "Mirian", "Ghost Iron", "Pyerite",
            "Tritanium", "Nocxium", "Isk", "Adamantine", "Astral Diamond"


            // Ensure you include all the elements you want
        };
        ...
        private const int NumberOfAbilitiesToAttach = 2;

        [Constructable]
        public NMRandomElemental() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = Utility.RandomList(13, 14, 15, 16, 300, 304, 199);
            Hue = Utility.RandomMinMax(1000, 1500);
            Name = elementNames[Utility.Random(elementNames.Length)] + " Elemental";
            SetStr(Utility.RandomMinMax(50, 500));
            SetDex(Utility.RandomMinMax(50, 500));
            SetInt(Utility.RandomMinMax(50, 500));
            SetHits(Utility.RandomMinMax(1000, 2000));
            ...
            Tamable = true;
			ControlSlots = Utility.RandomMinMax(3, 8);
			MinTameSkill = Utility.RandomMinMax(100, 200);

            PackPowerfulLoot();
			PackItem(new RandomFancyLightSource());
		...
		private void PackPowerfulMagicWeapon()
		{
			...
			weapon.Name = elementNames[Utility.Random(elementNames.Length)] + " " + elementNames[Utility.Random(elementNames.Length)] + " " + weapon.Name;
			// Give the weapon a random hue
			weapon.Hue = Utility.RandomMinMax(1000, 1500);
			PackItem(weapon);
		}
		...
		private void PackPowerfulMagicArmor()
		{
			...
			armor.Name = elementNames[Utility.Random(elementNames.Length)] + " " + elementNames[Utility.Random(elementNames.Length)] + " " + armor.Name;
			// Give the armor a random hue
			armor.Hue = Utility.RandomMinMax(1000, 1500);
			PackItem(armor);
		}
		...
		private void PackPowerfulMagicJewelry()
		{
			...
			jewel.Name = elementNames[Utility.Random(elementNames.Length)] + " " + elementNames[Utility.Random(elementNames.Length)] + " " + jewel.Name;
			// Give the jewelry a random hue
			jewel.Hue = Utility.RandomMinMax(1000, 1500);
			PackItem(jewel);
		}

        public NMRandomElemental(Serial serial) : base(serial)
        {
        }
