...
{
    [CorpseName("corpse of a unique pig")]
    public class NMRandomPig : BaseCreature
    {
        private static readonly int[] ridableBodies = new int[] { 0xCB, 0x122 }; // Pig body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Cute", "Chubby", "Curly", "Spotted", "Striped",
            "Fluffy", "Squeaky", "Snorty", "Grumpy", "Happy",
            "Hungry", "Lazy", "Cheeky", "Funny", "Friendly",
            "Smart", "Lucky", "Pink", "Black", "White",
			"Snuggly", "Sloppy", "Bubbly", "Giggly", "Dizzy",
			"Fuzzy", "Wiggly", "Jolly", "Nifty", "Dandy",
			"Pudgy", "Whiskered", "Rotund", "Chunky", "Merry",
			"Zippy", "Wobbly", "Gleeful", "Plump", "Ticklish",
			"Perky", "Frisky", "Rosy", "Gleaming", "Radiant",
			"Flamboyant", "Sprightly", "Zesty", "Brisk", "Bouncy",
			"Glimmering", "Radiant", "Twinkling", "Jubilant", "Sparkling",
			"Lively", "Mirthful", "Merry", "Jovial", "Vivacious",
			"Joyful", "Jocular", "Animated", "Blissful", "Chipper",
			"Carefree", "Energetic", "Lighthearted", "Jaunty", "Upbeat",
			"Spry", "Agile", "Breezy", "Crisp", "Dapper",
			"Effervescent", "Fleet", "Glossy", "Harmonious", "Invigorated",
			"Jaunty", "Keen", "Lithe", "Majestic", "Nimble",
			"Opulent", "Pristine", "Quirky", "Rambunctious", "Sleek",
			"Thriving", "Unabashed", "Vibrant", "Whimsical", "Xenial",
			"Yielding", "Zealous", "Adept", "Buoyant", "Clever",
			"Deft", "Ebullient", "Fanciful", "Gracious", "Hilarious",
			"Illuminated", "Jubilant", "Kindly", "Luminous", "Mystical",
			"Novel", "Optimistic", "Piquant", "Quaint", "Resilient",
			"Serene", "Tranquil", "Ubiquitous", "Venerable", "Winsome",
			"Exuberant", "Youthful", "Zany", "Affable", "Blithe"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Pig", "Piglet", "Hog", "Boar", "Sow",
            "Swine", "Porker", "Ham", "Bacon", "Rasher",
            "Oinker", "Porky", "Piggy", "Wilbur", "Babe",
            "Peppa", "George", "Olivia", "Pua", "Ganon",
			"Snout", "Piggybank", "Trotter", "Tusk", "Squealer",
			"Porkchop", "Pigskin", "Squeal", "Tenderloin", "Bristle",
			"Trotter", "Grunt", "Slop", "Pigsty", "Chop",
			"Oink", "Piglet", "Hogwash", "Snout", "Pigpen",
			"Mud", "Truffle", "Rooter", "Boarhound", "Mudpie",
			"Trough", "Oinker", "Swineherd", "Trotters", "Porkbelly",
			"Baconator", "Piggywig", "Wallow", "Pigtail", "Mudbath",
			"Piglet", "Rasher", "Pigpen", "Hamlet", "Piglet",
			"Grunt", "Pigsty", "Sow", "Baconator", "Piglet",
			"Chops", "Hamlet", "Mudbath", "Oinker", "Pigsty",
			"Snuffler", "Porcine", "Grunter", "Haunch", "Barrow",
			"Berkshire", "Chester", "Duroc", "Gilt", "Hereford",
			"Iberico", "Jowl", "Kurobuta", "Landrace", "Mulefoot",
			"Napoleon", "Osso", "Pancetta", "Quinta", "Rack",
			"Spit", "Tamworth", "Uncured", "Vietnamese", "Wattles",
			"Yorkshire", "Zampone", "Applewood", "Butcher", "Coppa",
			"Durham", "Ember", "Farrow", "Guanciale", "Hock",
			"Ironwood", "Jamon", "Kielbasa", "Lardo", "Morcilla",
			"Neck", "Offal", "Picnic", "Quiver", "Riblet",
			"Scrapple", "Tender", "Umbles", "Vindaloo", "Weaner",
			"Xiang", "Yucatan", "Zabuton", "Abruzzese", "Belly"
        };
        ...
        [Constructable]
        public NMRandomPig() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public NMRandomPig(Serial serial) : base(serial)
        {
        }
