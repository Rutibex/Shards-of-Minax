...
namespace Server.Mobiles
{
    ...
    public class NMRandomBear : BaseCreature
    {
        private static readonly int[] bearBodies = new int[] { 0xD3, 0xA7, 0xD4, 0xD5 }; // Bear body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Furry", "Ferocious", "Cuddly", "Giant", "Tiny",
			"Fluffy", "Grizzly", "Polar", "Black", "Brown",
			"Honey", "Snowy", "Ice", "Fire", "Thunder",
			"Claw", "Fang", "Roar", "Growl", "Snarl",
			"Wild", "Massive", "Savage", "Mighty", "Raging",
			"Majestic", "Sleek", "Powerful", "Swift", "Vicious",
			"Ruthless", "Lumbering", "Brutal", "Strong", "Sinister",
			"Beastly", "Menacing", "Untamed", "Formidable", "Fiery",
			"Roaring", "Fierce", "Hulking", "Epic", "Monstrous",
			"Dangerous", "Dominant", "Stern", "Agile", "Tenacious",
			"Ancient", "Barbaric", "Charming", "Dauntless", "Enraged",
			"Frosty", "Gallant", "Hearty", "Infernal", "Jovial",
			"Knotted", "Lone", "Mystic", "Nimble", "Ominous",
			"Primeval", "Quirky", "Ravaging", "Stoic", "Turbulent",
			"Unyielding", "Valiant", "Wise", "Xenial", "Youthful",
			"Zealous", "Ardent", "Blazing", "Cryptic", "Daring",
			"Ethereal", "Flickering", "Glacial", "Harsh", "Impenetrable",
			"Jagged", "Keen", "Lurking", "Miraculous", "Noble",
			"Obsidian", "Pristine", "Quintessential", "Resilient", "Shadowy",
			"Towering", "Unruly", "Venerable", "Wandering", "Exalted",
			"Yawning", "Zephyr", "Ambush", "Blizzard", "Crescent"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Bear", "Bruin", "Ursus", "Ursa", "Cub",
			"Panda", "Koala", "Sloth", "Teddy", "Beary",
			"Buddy", "Baloo", "Paddington", "Pooh", "Yogi",
			"Boo-Boo", "Fozzie", "Smokey", "Winnie", "Rupert",
			"Claws", "Paws", "Creature", "Animal", "Furry Friend",
			"Guardian", "Companion", "Protector", "Hunter", "Wanderer",
			"Champion", "Defender", "Stalker", "Warrior", "Nomad",
			"Nomad", "Prowler", "Seeker", "Traveler", "Explorer",
			"Loner", "Survivor", "Adventurer", "Scout", "Wanderer",
			"Nomad", "Pioneer", "Roamer", "Strider", "Tracker",
			"Goliath", "Titan", "Behemoth", "Gargoyle", "Mammoth",
			"Colossus", "Giantess", "Leviathan", "Spectre", "Phantom"
        };
        ...
        [Constructable]
        public NMRandomBear() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = bearBodies[Utility.Random(bearBodies.Length)];
        ...
        public NMRandomBear(Serial serial) : base(serial)
        {
        }
