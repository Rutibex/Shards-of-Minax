...
{
    [CorpseName("corpse of a unique arachnid")]
    public class NMRandomArachnid : BaseCreature
    {
        private static readonly int[] arachnidBodies = new int[] { 0xAD, 0xB, 0x13, 0x14, 0x1C }; // Arachnid body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Venomous", "Silent", "Cunning", "Vicious", "Stealthy",
			"Ancient", "Mythic", "Enchanted", "Wise", "Valiant",
			"Bold", "Legendary", "Stalwart", "Vigilant", "Radiant",
			"Sinister", "Fierce", "Nimble", "Savage", "Shadowy",
			"Elder", "Mystical", "Heroic", "Intelligent", "Fearless",
			"Swift", "Majestic", "Ethereal", "Regal", "Daring",
			"Crafty", "Lethal", "Mysterious", "Resilient", "Elegant",
			"Mighty", "Dreadful", "Brilliant", "Noble", "Ferocious",
			"Sly", "Powerful", "Supreme", "Glorious", "Clever",
			"Formidable", "Radiant", "Majestic", "Tenacious", "Gallant",
			"Relentless", "Unyielding", "Invisible", "Arcane", "Primal",
			"Unseen", "Guardian", "Frozen", "Blazing", "Stormy",
			"Impenetrable", "Infernal", "Celestial", "Unstoppable", "Ruthless",
			"Undying", "Reckless", "Phantom", "Inscrutable", "Primeval",
			"Invincible", "Spectral", "Boundless", "Infinite", "Dark",
			"Lightning", "Thunderous", "Spectral", "Fiery", "Icy",
			"Tempestuous", "Bewitched", "Hallowed", "Accursed", "Eclipsed",
			"Shrouded", "Warrior", "Enraged", "Sorcerous", "Unbreakable",
			"Stormborn", "Shadowbound", "Flamehearted", "Ironclad", "Ghostly",
			"Miraculous", "Frostbound", "Windwalker", "Starborn", "Moonlit"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Spider", "Tarantula", "Scorpion", "Black Widow", "Brown Recluse",
			"Huntsman", "Wolf Spider", "Goliath Birdeater", "Trapdoor Spider", "Jumping Spider",
			"Orb Weaver", "Daddy Longlegs", "Redback", "Funnel Web", "Camel Spider",
			"Nightstalker", "Deathweaver", "Venomfang", "Shadowspinner", "Hellscorpion",
			"Doomweaver", "Nightmarecrawler", "Fangterror", "Dreadscuttle", "Voidspider",
			"Darkspinner", "Terrorarachnid", "Soulreaver", "Duskstalker", "Graveclaw",
			"Abyssal Spider", "Phantom Arachnid", "Spectral Weaver", "Twilight Stalker", "Eldritch Spinner",
			"Chaosweaver", "Doomspinner", "Nightmare Arachnid", "Cursed Widow", "Spectral Scuttler",
			"Shadowweaver", "Twilight Terror", "Eclipse Spider", "Abyssal Stalker", "Wraithspinner",
			"Voidweaver", "Nightmare Widow", "Phantom Scuttler", "Dreadspinner", "Ethereal Arachnid",
			"Bloodfang", "Stormweaver", "Ironspinner", "Frostscorpion", "Flameweaver",
			"Voidwalker", "Dreamweaver", "Soulspinner", "Iceweaver", "Thunderclaw",
			"Starweaver", "Moonspinner", "Sunscorcher", "Eclipseweaver", "Cosmiccrawler",
			"Galactic Spinner", "Nebulaweaver", "Cometstalker", "Solar Spider", "Lunar Scorpion",
			"Astral Weaver", "Celestial Spider", "Dimensional Scuttler", "Quantum Spider", "Voidcrawler",
			"Stardust Weaver", "Nebula Spider", "Cosmoscrawler", "Galaxyweaver", "Meteorshower Spider",
			"Event Horizon Scorpion", "Blackhole Spider", "Supernova Scorpion", "Wormhole Weaver", "Timeless Tarantula",
			"Interstellar Spider", "Celestial Scorpion", "Orbitweaver", "Spacewalker Spider", "Starlight Stalker",
			"Voidshifter", "Cosmic Dust Weaver", "Galactic Nightcrawler", "Stellar Spider", "Aurora Weaver"
        };
        ...
        [Constructable]
        public NMRandomArachnid() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = arachnidBodies[Utility.Random(arachnidBodies.Length)];
        ...
        public NMRandomArachnid(Serial serial) : base(serial)
        {
        }
