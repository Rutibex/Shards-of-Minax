...
{
    [CorpseName("corpse of a unique ape")]
    public class NMRandomApe : BaseCreature
    {
        private static readonly int[] ridableBodies = new int[] { 0x1D, 0x1F }; // Ape body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Furious", "Mighty", "Savage", "Cunning", "Primal",
			"Giant", "Feral", "King", "Queen", "Alpha",
			"Wild", "Untamed", "Rampant", "Loyal", "Nimble",
			"Agile", "Clever", "Smart", "Curious", "Friendly",
			"Brutal", "Vicious", "Dominant", "Swift", "Fearless",
			"Stalwart", "Daring", "Tenacious", "Dexterous", "Wise",
			"Intelligent", "Perceptive", "Observant", "Resourceful", "Astute",
			"Sharp", "Quick", "Energetic", "Vigilant", "Sturdy",
			"Resilient", "Robust", "Staunch", "Steadfast", "Determined",
			"Indomitable", "Relentless", "Valiant", "Courageous", "Dauntless",
			"Battle-Hardened", "Unyielding", "Majestic", "Noble", "Fierce",
			"Imposing", "Legendary", "Mythic", "Enigmatic", "Mystical",
			"Inscrutable", "Prowess", "Formidable", "Invincible", "Ruthless",
			"Unstoppable", "Ingenious", "Innovative", "Crafty", "Dynamic",
			"Fiery", "Icy", "Thunderous", "Impenetrable", "Unbreakable",
			"Revered", "Honored", "Solemn", "Ancient", "Timeless",
			"Ethereal", "Phantom", "Shadowy", "Radiant", "Dazzling",
			"Spectral", "Invisible", "Mystic", "Celestial", "Infernal",
			"Epic", "Heroic", "Legendary", "Fabled", "Mythical"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Ape", "Gorilla", "Orangutan", "Chimpanzee", "Baboon",
			"Mandrill", "Gibbon", "Bonobo", "Macaque", "Lemur",
			"Capuchin", "Tamarin", "Marmoset", "Howler", "Saki",
			"Spider", "Squirrel", "Colobus", "Langur", "Loris",
			"Barbary", "Gelada", "Indri", "Proboscis", "Tarsier",
			"Guereza", "Patas", "Binturong", "Chacma", "Guinea",
			"Diana", "Pygmy", "Ruffed", "Silverback", "White-faced",
			"Golden", "Red", "Black", "Brown", "Gray",
			"Green", "Blue", "Purple", "Crimson", "Emerald",
			"Uakari", "Drill", "Guenon", "Mangabey", "Papio",
			"Woolly", "Night", "Owl", "Snow", "Mountain",
			"Desert", "Forest", "River", "Marsh", "Arctic",
			"Volcanic", "Island", "Cave", "Plains", "Coastal",
			"Sky", "Sun", "Moon", "Star", "Comet",
			"Eclipse", "Galaxy", "Nebula", "Meteor", "Solar",
			"Lunar", "Celestial", "Cosmic", "Aurora", "Zodiac",
			"Equatorial", "Polar", "Temperate", "Tropical", "Subtropical",
			"Marshland", "Highland", "Lowland", "Rainforest", "Savannah",
			"Bamboo", "Pine", "Oak", "Meadow", "Fjord"
        };
        ...
        [Constructable]
        public NMRandomApe() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public NMRandomApe(Serial serial) : base(serial)
        {
        }
