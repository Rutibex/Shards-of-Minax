...
{
    [CorpseName("corpse of a unique wizard or witch")]
    public class NMRandomWizardWitch : BaseCreature
    {
        private static readonly int[] wizardWitchBodies = new int[] { 0xFD, 0xFF, 0x94, 0x92, 0x302, 0x7C, 0x7D, 0x4E, 0x2FD }; // Wizard and witch body values
        private static readonly string[] wordBank1 = new string[]
        {
            "Mystic", "Arcane", "Enigmatic", "Sage", "Wise",
            "Ancient", "Mythic", "Enchanted", "Powerful", "Legendary",
            "Ethereal", "Celestial", "Astral", "Mystical", "Occult",
            "Esoteric", "Secretive", "Reclusive", "Sorcerous", "Magical",
			"Arcane", "Elusive", "Sagacious", "Eldritch", "Profound",
			"Primordial", "Fabled", "Bewitched", "Formidable", "Epic",
			"Supernal", "Sidereal", "Spiritual", "Cryptic", "Obscure",
			"Abstruse", "Clandestine", "Solitary", "Thaumaturgic", "Magnetic",
			"Sinister", "Ominous", "Dark", "Infernal", "Diabolic",
			"Malefic", "Baleful", "Nefarious", "Malign", "Spectral",
			"Phantasmal", "Chimeric", "Ghostly", "Apparitional", "Eerie",
			"Uncanny", "Sinister", "Mysterious", "Ineffable", "Enigmatic",
			"Cabalistic", "Runic", "Talismatic", "Hermetic", "Alchemical",
			"Shamanistic", "Totemic", "Animistic", "Druidic", "Pagan",
			"Goetic", "Thelemic", "Enochian", "Qliphotic", "Kabbalistic",
			"Theurgic", "Thaumaturgical", "Elemental", "Naturalistic", "Cosmic",
			"Sinister", "Ominous", "Dark", "Gloomy", "Baleful",
			"Infernal", "Demonic", "Diabolic", "Fiendish", "Malefic",
			"Cursed", "Bewitched", "Hexed", "Jinxed", "Haunted",
			"Spectral", "Phantasmal", "Apparitional", "Eerie", "Uncanny",
			"Necromantic", "Occultist", "Hermetic", "Kabbalistic", "Alchemical",
			"Runic", "Talismantic", "Sigilistic", "Shamanistic", "Totemic",
			"Goetic", "Thelemic", "Enochian", "Rosicrucian", "Theurgic",
			"Elemental", "Cosmic", "Astral", "Sidereal", "Stellar"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Wizard", "Warlock", "Sorcerer", "Magus", "Mage",
            "Conjurer", "Enchanter", "Illusionist", "Necromancer", "Diviner",
            "Witch", "Hag", "Crone", "Seeress", "Oracle",
            "Spellbinder", "Spellweaver", "Spellcaster", "Hexer", "Caster",
			"Alchemist", "Warlock", "Theurge", "Thaumaturge", "Archmage",
			"Invoker", "Evoker", "Transmuter", "Abjurer", "Druid",
			"Shaman", "Psychic", "Medium", "Soothsayer", "Prophet",
			"Spellsinger", "Spellsmith", "Incantator", "Jinxer", "Charmer",
			"Warlock", "Sorceress", "Magician", "Prestidigitator", "Illusionist",
			"Conjuror", "Summoner", "Binder", "Banisher", "Exorcist",
			"Witchdoctor", "Voodooist", "Hoodooist", "Spiritualist", "Channeler",
			"Clairvoyant", "Telepath", "Empath", "Pyromancer", "Hydromancer",
			"Geomancer", "Aeromancer", "Necromancer", "Demonologist", "Occultist",
			"Ceremonialist", "Ritualist", "Diviner", "Augur", "Haruspex",
			"Seer", "Prophetess", "Sibyl", "Oracle", "Psychometrist",
			"Dowsser", "Scryer", "Medium", "Spiritist", "Mystic",
			"Magician", "Occultist", "Necromancer", "Druid", "Shaman",
			"Psychic", "Clairvoyant", "Medium", "Spiritualist", "Channeler",
			"Hierophant", "Mystagogue", "Theurge", "Thaumaturge", "Alchemist",
			"Runemaster", "Talismonger", "Sigilist", "Goetia", "Enochianist",
			"Rosicrucian", "Cabalist", "Kabbalist", "Hermetist", "Adept",
			"Mage", "Sorceress", "Warlock", "Conjurer", "Enchantress",
			"Illusionist", "Diviner", "Seer", "Prophet", "Augur",
			"Haruspex", "Spellsinger", "Incantator", "Charmweaver", "Hexmaster"
        };
        ...
        [Constructable]
        public NMRandomWizardWitch() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = wizardWitchBodies[Utility.Random(wizardWitchBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyMedicine());
        ...
        public NMRandomWizardWitch(Serial serial) : base(serial)
        {
        }
