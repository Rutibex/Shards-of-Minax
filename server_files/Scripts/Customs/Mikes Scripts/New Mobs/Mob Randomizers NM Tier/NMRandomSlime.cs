...
{
    [CorpseName("corpse of a unique slime")]
    public class NMRandomSlime : BaseCreature
    {
        private static readonly int[] slimeBodies = new int[] { 0x9E, 0x111, 0x13F, 0x100, 0x307, 0x315, 0x33, 0x5E, 0x13C }; // Slime body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Slimy", "Gooey", "Sticky", "Squishy", "Bouncy",
			"Gelatinous", "Viscous", "Lumpy", "Moldy", "Fragrant",
			"Acidic", "Alkaline", "Toxic", "Radioactive", "Luminous",
			"Fluffy", "Crunchy", "Spicy", "Sweet", "Sour",
			"Sparkling", "Iridescent", "Spongy", "Rubbery", "Slick",
			"Pungent", "Sizzling", "Chewy", "Fizzy", "Zesty",
			"Pungent", "Sizzling", "Chewy", "Fizzy", "Zesty",
			"Crackling", "Foamy", "Velvety", "Sapid", "Succulent",
			"Spongy", "Pliable", "Granular", "Pulpy", "Crystalline",
			"Zingy", "Tangy", "Aromatic", "Effervescent", "Sapid",
			"Whispering", "Ethereal", "Shimmering", "Glowing", "Mystical",
			"Enchanted", "Whimsical", "Dazzling", "Twinkling", "Glistening",
			"Shadowy", "Lurid", "Vivid", "Brilliant", "Opaque",
			"Translucent", "Waxy", "Silken", "Satiny", "Dewy",
			"Vaporous", "Windswept", "Astral", "Celestial", "Nebulous",
			"Mirage", "Phantasmal", "Spectral", "Eerie", "Bewitched",
			"Cobwebby", "Glittering", "Majestic", "Misty", "Radiant",
			"Chimerical", "Surreal", "Hazy", "Twilight", "Nocturnal",
			"Stellar", "Lunar", "Solar", "Infernal", "Elysian",
			"Arcane", "Eldritch", "Otherworldly", "Phantom", "Wraithlike",
			"Brittle", "Clingy", "Dense", "Elastic", "Feathery",
			"Fibrous", "Glossy", "Granulated", "Harsh", "Icy",
			"Jagged", "Knobby", "Leathery", "Metallic", "Nacreous",
			"Opaque", "Pearly", "Quivering", "Rough", "Silken",
			"Smooth", "Taut", "Translucent", "Ultraviolet", "Vibrant",
			"Whipped", "Xeric", "Yielding", "Zealous", "Ablaze",
			"Blazing", "Chilling", "Dazzling", "Echoing", "Flashing",
			"Glittering", "Holographic", "Incandescent", "Jubilant", "Kaleidoscopic",
			"Lucid", "Mystical", "Neon", "Ornate", "Prismatic",
			"Quixotic", "Radiant", "Shimmering", "Twinkling", "Undulating",
			"Vivid", "Wavy", "Xyloid", "Yearning", "Zenith"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Slime", "Blob", "Puddle", "Jelly", "Gel",
			"Ooze", "Mucus", "Gunk", "Sludge", "Snot",
			"Glue", "Jam", "Sauce", "Syrup", "Juice",
			"Soap", "Paint", "Ink", "Oil", "Wax",
			"Resin", "Slobber", "Drool", "Residue", "Lather",
			"Residue", "Film", "Cream", "Froth", "Lather",
			"Emulsion", "Extract", "Gelatin", "Saliva", "Tear",
			"Lacquer", "Varnish", "Solution", "Paste", "Concoction",
			"Frosting", "Glop", "Drippings", "Serum", "Extract",
			"Condiment", "Elixir", "Tincture", "Essence", "Compound",
			"Blend", "Clot", "Dew", "Ectoplasm", "Flux",
			"Gooze", "Haze", "Ichor", "Jell-O", "Kefir",
			"Lotion", "Mash", "Nectar", "Ointment", "Polish",
			"Quark", "Rime", "Slather", "Thickener", "Unction",
			"Vigor", "Weed", "Xanthan", "Yogurt", "Zymurgy",
			"Agar", "Balm", "Curdlan", "Dollop", "Enzyme",
			"Flan", "Gravy", "Honey", "Isinglass", "Jus",
			"Ketchup", "Lime", "Marmalade", "Nougat", "Opal",
			"Plasma", "Quince", "Roux", "Spread", "Tapioca",
			"Umami", "Veloute", "Whisky", "Xylose", "Yeast",
			"Zest", "Alginate", "Bisque", "Custard", "Dressing"
        };
        ...
        [Constructable]
        public NMRandomSlime() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = slimeBodies[Utility.Random(slimeBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyPotion());
        ...
        public NMRandomSlime(Serial serial) : base(serial)
        {
        }
