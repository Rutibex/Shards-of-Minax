...
{
    [CorpseName("corpse of a unique dragon")]
    public class NMRandomDragon : BaseCreature
    {
        private static readonly int[] dragonBodies = new int[] { 0x67, 0xC, 0x3C, 0x3B, 0x3D, 0xAC, 0x68, 0x3E, 0x109 }; // Dragon body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Flame", "Frost", "Storm", "Shadow", "Light",
			"Fire", "Ice", "Lightning", "Dark", "Sun",
			"Inferno", "Glacier", "Thunder", "Night", "Dawn",
			"Blaze", "Snow", "Spark", "Eclipse", "Star",
			"Magma", "Crystal", "Tornado", "Moon", "Dusk",
			"Glow", "Aurora", "Quake", "Twilight", "Nova",
			"Sizzle", "Sleet", "Tempest", "Shade", "Radiance",
			"Ash", "Hail", "Volt", "Dusk", "Sunrise",
			"Ember", "Chill", "Cyclone", "Dusk", "Comet",
			"Meteor", "Rain", "Heat", "Abyss", "Gale",
			"Cinder", "Fury", "Blizzard", "Obsidian", "Solar",
			"Vortex", "Mystic", "Celestial", "Infernal", "Lunar",
			"Phantom", "Mirage", "Nebula", "Cosmic", "Tidal",
			"Boreal", "Zephyr", "Flare", "Aether", "Polar",
			"Spectral", "Crystalline", "Nimbus", "Orbit", "Stellar",
			"Blast", "Pyro", "Frigid", "Umbral", "Solstice",
			"Equinox", "Vorpal", "Silhouette", "Crescent", "Maelstrom",
			"Torrent", "Cascade", "Ethereal", "Pandemonium", "Sovereign",
			"Rift", "Nether", "Arcane", "Enigma", "Tempestuous",
			"Whisper", "Eternal", "Void", "Galaxy", "Prism",
			"Ripple", "Harvest", "Grove", "Pinnacle", "Sentry",
			"Reverie", "Cascade", "Marine", "Avalanche", "Torrent",
			"Horizon", "Sage", "Oracle", "Pulse", "Surge",
			"Omen", "Legacy", "Vigil", "Zenith", "Apex",
			"Monolith", "Terra", "Mantle", "Nexus", "Sovereign",
			"Rune", "Fable", "Chasm", "Empyrean", "Aegis",
			"Harbinger", "Myth", "Wraith", "Sylvan", "Talisman",
			"Genesis", "Blight", "Vale", "Crusade", "Spire",
			"Requiem", "Sanctum", "Vanguard", "Paradox", "Dynamo"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Dragon", "Drake", "Wyrm", "Wyvern", "Serpent",
			"Lizard", "Reptile", "Beast", "Fiend", "Monster",
			"Scale", "Claw", "Fang", "Wing", "Tail",
			"Breath", "Roar", "Flare", "Blast", "Bite",
			"Leviathan", "Behemoth", "Basilisk", "Saurian", "Chimera",
			"Hydra", "Gargoyle", "Sphinx", "Manticore", "Griffin",
			"Dragonkin", "Serpentine", "Naga", "Viper", "Croc",
			"Scaly", "Draco", "Dinosaur", "Raptor", "Salamander",
			"Gecko", "Iguana", "Komodo", "Varan", "Ankyl",
			"Crested", "Horned", "Spiked", "Barbed", "Plated",
			"Fire-breather", "Sky-serpent", "Earth-dragon", "Sea-dragon", "Storm-wyrm",
			"Ice-wyrm", "Flame-drake", "Shadow-drake", "Venom-drake", "Iron-scale",
			"Thunder-beast", "Wind-serpent", "Stone-reptile", "Mystic-serpent", "Elder-drake",
			"Primeval-beast", "Ancient-wyrm", "Celestial-dragon", "Infernal-serpent", "Arcane-lizard",
        };
        ...
        [Constructable]
        public NMRandomDragon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = dragonBodies[Utility.Random(dragonBodies.Length)];
            ...
            PackPowerfulLoot();
			PackItem(new RandomFancyPainting());
        ...
        public NMRandomDragon(Serial serial) : base(serial)
        {
        }
