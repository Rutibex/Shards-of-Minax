...
{
    [CorpseName("corpse of a unique lizard")]
    public class NMRandomLizard : BaseCreature
    {
        private static readonly int[] lizardBodies = new int[] { 0x21, 0x23, 0x24, 0xCA, 0x85, 0x86, 0x51, 0x50 }; // Lizard body values
        private static readonly string[] wordBank1 = new string[]
        {
			...
			"Agile", "Magnificent", "Regal", "Heroic", "Feisty",
			"Sleek", "Poised", "Courageous", "Soul", "Arcane",
			"Primordial", "Saga", "Magical", "Intelligent", "Gallant",
			"Daring", "Fabled", "Resilient", "Watchful", "Luminous",
			"Stoic", "Fearless", "Majesty", "Valorous", "Steadfast",
			"Gentle", "Charismatic", "Dignified", "Dynamic", "Mysterious",
			"Timeless", "Sacred", "Bewitching", "Sagacious", "Chivalrous",
			"Dashing", "Epic", "Steadfast", "Vibrant", "Shimmering",
			"Nimble", "Impressive", "Royal", "Courageous", "Lively",
			"Streamlined", "Composed", "Dauntless", "Heart", "Esoteric",
			"Primal", "Chronicle", "Sorcerous", "Genius", "Charming",
			"Audacious", "Folklore", "Enduring", "Vigilant", "Gleaming"
        };

        private static readonly string[] wordBank2 = new string[]
        {
            "Lizard", "Reptile", "Drake", "Dragon", "Wyrm",
            "Serpent", "Viper", "Basilisk", "Gecko", "Skink",
            "Monitor", "Iguana", "Chameleon", "Salamander", "Newt",
			"Turtle", "Tortoise", "Caiman", "Alligator", "Crocodile",
			"Snake", "Adder", "Cobra", "Python", "Anole",
			"Tegu", "Frilled", "Horned", "Axolotl", "Frog",
			"Toad", "Hydra", "Naga", "Amphibian", "Tuatara", "Heloderma",
			"Gharial", "Varanus", "Agama", "Uromastyx", "Thunder",
			"Veiled", "Bearded", "Water", "Green", "Leaf-tailed",
			"Mud", "Tree", "Glass", "Poison", "Flying",
			"Rat", "Racer", "Coral", "King", "Milk",
			"Boa", "Rattlesnake", "Garter", "Blind", "Bullfrog",
			"Treefrog", "Caecilian", "Fire", "Jelly", "Red-eyed"
        };
        ...
        [Constructable]
        public NMRandomLizard() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = lizardBodies[Utility.Random(lizardBodies.Length)];
        ...
        public NMRandomLizard(Serial serial) : base(serial)
        {
        }
