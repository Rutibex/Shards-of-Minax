...
{
    [CorpseName("corpse of a unique bovine")]
    public class NMRandomBovine : BaseCreature
    {
        private static readonly int[] bovineBodies = new int[] { 0xE8, 0xE9, 0xD8, 0xE7 }; // Bovine body values
        private static readonly string[] wordBank1 = new string[]
        {
			"Mighty", "Gentle", "Stubborn", "Loyal", "Furry",
			"Cuddly", "Spotted", "Horned", "Milky", "Cheesy",
			"Grassy", "Mooing", "Chewing", "Bellowing", "Buttery",
			"Beefy", "Hefty", "Fluffy", "Curly", "Leathery",
			"Sleek", "Grazing", "Whiskered", "Roaming", "Tender",
			"Wholesome", "Contented", "Sunny", "Rainy", "Frosty",
			"Breezy", "Velvety", "Stout", "Fuzzy", "Grazing",
			"Peaceful", "Humble", "Joyful", "Silent", "Plump",
			"Rustic", "Pristine", "Amiable", "Harmonious", "Enchanting",
			"Serene", "Bucolic", "Bustling", "Radiant", "Soothing",
			"Whimsical", "Dappled", "Sturdy", "Majestic", "Noble",
			"Playful", "Drowsy", "Ponderous", "Vigorous", "Sprightly",
			"Twinkling", "Dreamy", "Luminous", "Mystical", "Tranquil",
			"Vibrant", "Diligent", "Mirthful", "Wistful", "Jubilant",
			"Zesty", "Windy", "Starlit", "Moonlit", "Sunset",
			"Sunrise", "Twilight", "Midnight", "Glistening", "Shimmering",
			"Whispering", "Swaying", "Drifting", "Soaring", "Wandering",
			"Lost", "Found", "Seeking", "Questing", "Journeying",
			"Meandering", "Roaring", "Thundering", "Lightning", "Stormy"
        };

        private static readonly string[] wordBank2 = new string[]
        {
			"Cow", "Bull", "Ox", "Calf", "Heifer",
			"Steer", "Bison", "Buffalo", "Yak", "Zebu",
			"Gaur", "Highland", "Jersey", "Angus", "Hereford",
			"Holstein", "Limousin", "Charolais", "Simmental", "Shorthorn",
			"Texas Longhorn", "Aberdeen Angus", "Guernsey", "Brahman", "Dairy",
			"Fresian", "Devon", "Wagyu", "Texas Ranger", "Scottish Highlander",
			"Santa Gertrudis", "Gelbvieh", "Red Poll", "Black Angus", "Ayrshire",
			"South Devon", "Tarentaise", "Belted Galloway", "Dexter", "Normande",
			"Randall", "Canadienne", "Vosges", "Harz Red Mountain", "Piedmontese",
			"Belgian Blue", "Florida Cracker", "Chianina", "Maine-Anjou", "Nguni",
			"Muskox", "Indicus", "Taurus", "Belgian Red", "Lincoln Red",
			"White Park", "Blue Grey", "Montbéliarde", "Norwegian Red", "Swedish Red",
			"Irish Moiled", "Kerry", "Lakenvelder", "Gloucester", "Whitebred Shorthorn",
			"Salers", "Pinzgauer", "Romagnola", "Maremmana", "Marchigiana",
			"Blonde d'Aquitaine", "Parthenais", "Gascon", "Aubrac", "Bazadais",
			"Charbray", "Senepol", "Tuli", "Boran", "Gelbray",
			"Indo-Brazilian", "Beefmaster", "Braford", "Brangus", "Simbrah",
			"Lim-Flex", "Ukrainian Grey", "Vaynol", "Welsh Black", "Red Angus",
			"American White Park", "British White", "Corriente", "Criollo", "Galloway"
        };
        ...
        [Constructable]
        public NMRandomBovine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = bovineBodies[Utility.Random(bovineBodies.Length)];
        ...
        public NMRandomBovine(Serial serial) : base(serial)
        {
        }
