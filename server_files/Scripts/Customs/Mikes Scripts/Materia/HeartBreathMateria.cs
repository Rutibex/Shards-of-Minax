...
{
    // ---------------------------------------------------
    // Heart Breath Materia
    // This materia, when socketed, allows the bearer to unleash a heart breath attack
    // ---------------------------------------------------

    public class HeartBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public HeartBreathMateria() : base(0x280A) // Use the item ID for your materia graphic
        {
            Name = "Heart Breath Materia";
        ...
        public HeartBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Heart Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlHeartBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
