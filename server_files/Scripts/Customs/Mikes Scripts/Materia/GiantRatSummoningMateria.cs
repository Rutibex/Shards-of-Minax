...
{
    // ---------------------------------------------------
    // GiantRat Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a GiantRat on hit
    // ---------------------------------------------------

    public class GiantRatSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GiantRatSummoningMateria() : base(0x1234) // Replace with the graphic ID you want for your materia
        {
            Name = "Summoning GiantRat Materia";
        ...
        public override int Icon { get { return 0x1234; } } // Icon to use in the socketing menu
        ...
        public GiantRatSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a GiantRat.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GiantRat", 99, 5.0));
                return true;
            }
            return false;
        }
