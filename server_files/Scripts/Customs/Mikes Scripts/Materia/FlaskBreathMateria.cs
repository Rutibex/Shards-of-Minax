...
{
    // ---------------------------------------------------
    // Flask Breath Materia
    // This materia, when socketed, allows the bearer to unleash a flask breath attack
    // ---------------------------------------------------

    public class FlaskBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public FlaskBreathMateria() : base(0x280A) // Use the item ID for your materia graphic
        {
            Name = "Flask Breath Materia";
        ...
        public FlaskBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Flask Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlFlaskBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
