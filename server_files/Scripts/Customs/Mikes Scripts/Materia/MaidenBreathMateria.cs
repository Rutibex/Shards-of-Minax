...
{
    // ---------------------------------------------------
    // Maiden Breath Materia
    // This materia, when socketed, allows the bearer to unleash a maiden breath attack
    // ---------------------------------------------------

    public class MaidenBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public MaidenBreathMateria() : base(0x280A) // Use the item ID for your materia graphic
        {
            Name = "Maiden Breath Materia";
        ...
        public MaidenBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating maiden breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Maiden Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlMaidenBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
