...
{
    // ---------------------------------------------------
    // Water Breath Materia
    // This materia, when socketed, allows the bearer to unleash a water breath attack
    // ---------------------------------------------------

    public class WaterBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public WaterBreathMateria() : base(0x280A) // Use the item ID for your materia graphic
        {
            Name = "Water Breath Materia";
        ...
        public WaterBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a watery breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Water Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlWaterBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
