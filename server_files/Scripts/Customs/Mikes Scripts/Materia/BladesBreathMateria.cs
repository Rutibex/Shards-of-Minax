...
{
    // ---------------------------------------------------
    // Blades Breath Materia
    // This materia, when socketed, allows the bearer to unleash a blades breath attack
    // ---------------------------------------------------

    public class BladesBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BladesBreathMateria() : base(0x280A) // Use the item ID for your materia graphic
        {
            Name = "Blades Breath Materia";
        ...
        public BladesBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Blades Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlBladesBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
