...
{
    // ---------------------------------------------------
    // Vortex Breath Materia
    // This materia, when socketed, allows the bearer to unleash a vortex breath attack
    // ---------------------------------------------------

    public class VortexBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public VortexBreathMateria() : base(0x280A) // Use the item ID for your materia graphic
        {
            Name = "Vortex Breath Materia";
        ...
        public VortexBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating vortex breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Vortex Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlVortexBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
