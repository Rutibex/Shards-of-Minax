...
namespace Solaris.ItemStore
{
    ...
    public class InstrumentEntry : StoreEntry
    {
        ...
        public InstrumentEntry(Type type,ItemQuality quality,string name) : this(type,null,quality,name,0)
        {
        }

        //default constructor: set up several types, a quality, a name, and default 0 quantity
        public InstrumentEntry(Type type,Type[] types,ItemQuality quality,string name) : this(type,types,quality,name,0)
        {
        }

        //default constructor: set up one type, a quality, a name, an amount, and default size/offset of artwork
        public InstrumentEntry(Type type,ItemQuality quality,string name,int amount) : this(type,null,quality,name,amount,25,0,0)
        {
        }

        //default constructor: set up types, a quality, a name, an amount, and default size/offset of artwork
        public InstrumentEntry(Type type,Type[] types,ItemQuality quality,string name,int amount) : this(type,types,quality,name,amount,25,0,0)
        {
        }

        //default constructor, set up a type, quality, name, amount, size/offset of artwork
        public InstrumentEntry(Type type,ItemQuality quality,string name,int amount,int height,int x,int y) : this(type,null,quality,name,amount,height,x,y)
        {
        }

        //master constructor: set up types, quality, a name, an amount, and size/offset of artwork
        public InstrumentEntry(Type type,Type[] types,ItemQuality quality,string name,int amount,int height,int x,int y) : base(type,types,name,amount,height,x,y)
        {
            _Quality = quality;
        }
