...
namespace Server.Mobiles
{
    ...
    {
        public static double ChestChance = 1;// Chance that a paragon will carry a paragon chest
		...
		public static bool CheckConvert(BaseCreature bc, Point3D location, Map m)
		{
			...
			// Increase the chance by 4 times
			double chance = 4 / Math.Round(20.0 - (fame / 3200));
