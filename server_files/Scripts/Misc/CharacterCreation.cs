		...
		private static void AddSkillItems(SkillName skill, Mobile m)
		{
			...
			switch (skill)
			{
				...
				case SkillName.DetectHidden:
				{
					...
					PackItem(new UniversalAbsorbingDyeTub());
